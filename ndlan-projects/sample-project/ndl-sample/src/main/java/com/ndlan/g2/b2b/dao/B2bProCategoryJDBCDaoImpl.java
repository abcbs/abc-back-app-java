...
@Repository("b2bProCategoryJDBCDao")
public class B2bProCategoryJDBCDaoImpl implements B2bProCategoryJDBCDao {
    ...
    public int insertSelective(B2bProCategoryBean b2bProCategory) {
        try {
            ...
            if (null != b2bProCategory.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bProCategory.getUpdateTime());
            }
            if (null != b2bProCategory.getCategoryName()) {
                columns.add("category_name");
                values.add(b2bProCategory.getCategoryName());
            }
            if (null != b2bProCategory.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bProCategory.getCreateTime());
            }
            if (null != b2bProCategory.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bProCategory.getCreateBy());
            }
            ...
            if (null != b2bProCategory.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bProCategory.getUpdateBy());
            }
    ...
    public int updateByPrimaryKeySelective(B2bProCategoryBean b2bProCategory) {
        try {
            ...
            if (null != b2bProCategory.getUpdateTime()) {
                ...
                params.add(b2bProCategory.getUpdateTime());
            }
            if (null != b2bProCategory.getCategoryName()) {
            ...
            if (null != b2bProCategory.getCreateTime()) {
                ...
                params.add(b2bProCategory.getCreateTime());
            }
            if (null != b2bProCategory.getCreateBy()) {
                updateSql.add("create_by = ?");
                params.add(b2bProCategory.getCreateBy());
            }
            if (null != b2bProCategory.getRestId()) {
            ...
            if (null != b2bProCategory.getUpdateBy()) {
                ...
                params.add(b2bProCategory.getUpdateBy());
            }
            if (null != b2bProCategory.getCategoryGrade()) {
