...
@Repository("b2bShoppingCartPkgDao")
public class B2bShoppingCartPkgDaoImpl implements B2bShoppingCartPkgDao {
    ...
    public int insertSelective(B2bShoppingCartPkgBean b2bShoppingCartPkg) {
        try {
            ...
            if (null != b2bShoppingCartPkg.get()) {
                columns.add("");
                values.add(b2bShoppingCartPkg.get());
            }
            if (null != b2bShoppingCartPkg.get()) {
                columns.add("");
                values.add(b2bShoppingCartPkg.get());
    ...
    public int updateByPrimaryKeySelective(B2bShoppingCartPkgBean b2bShoppingCartPkg) {
        try {
            ...
            if (null != b2bShoppingCartPkg.get()) {
                updateSql.add(" = ?");
                params.add(b2bShoppingCartPkg.get());
            }
            if (null != b2bShoppingCartPkg.get()) {
                updateSql.add(" = ?");
                params.add(b2bShoppingCartPkg.get());
