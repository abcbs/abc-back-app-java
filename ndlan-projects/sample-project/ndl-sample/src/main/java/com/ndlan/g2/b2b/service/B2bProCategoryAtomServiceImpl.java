...
public class B2bProCategoryAtomServiceImpl  extends BaseService<B2bProCategoryDao, 
	...
	SQLParam sqlParam=new SQLParam();
        ...
        String createBy = b2bProCategory.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProCategory.getCreateBy());
        }
        ...
        String updateBy = b2bProCategory.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProCategory.getUpdateBy());
        }
        ...
        String updateTime = b2bProCategory.getUpdateTime();
        if (StringUtils.isNotBlank(updateTime) ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProCategory.getUpdateTime());
        }
      
            
        String createTime = b2bProCategory.getCreateTime();
        if (StringUtils.isNotBlank(createTime) ) {
           sqlBuffer.append("createTime=?");
	    
	     param.add(b2bProCategory.getCreateTime());
        }
    ...
    public B2bProCategoryBean trimStringValue(B2bProCategoryBean b2bProCategory) {
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bProCategory.setCreateBy(createBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bProCategory.setUpdateBy(updateBy.substring(0, 36));
        }
        ...
        String updateTime = b2bProCategory.getUpdateTime();
        if (StringUtils.isNotBlank(updateTime) && updateTime.length() > 36) {
            b2bProCategory.setUpdateTime(updateTime.substring(0, 36));
        }

        String createTime = b2bProCategory.getCreateTime();
        if (StringUtils.isNotBlank(createTime) && createTime.length() > 36) {
            b2bProCategory.setCreateTime(createTime.substring(0, 36));
        }
