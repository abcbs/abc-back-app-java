...
@Repository("b2bLogisticsOrderDeliveryDao")
public class B2bLogisticsOrderDeliveryDaoImpl implements B2bLogisticsOrderDeliveryDao {
            ...
            List<B2bLogisticsOrderDeliveryBean> resultList = this.jdbcTemplate.query(sql, new Object[]{lgstOrdDlvId},
                    new RowMapper<B2bLogisticsOrderDeliveryBean>() {
                        ...
                        public B2bLogisticsOrderDeliveryBean mapRow(ResultSet rs, int rowNum) throws SQLException {
                            ...
                            bean.setGoodsType(rs.getString("goods_type"));
    ...
    public int insertSelective(B2bLogisticsOrderDeliveryBean b2bLogisticsOrderDelivery) {
        try {
            ...
            if (null != b2bLogisticsOrderDelivery.getGoodsType()) {
                columns.add("goods_type");
                values.add(b2bLogisticsOrderDelivery.getGoodsType());
            }
            ...
            if (null != b2bLogisticsOrderDelivery.get()) {
                columns.add("");
                values.add(b2bLogisticsOrderDelivery.get());
            }
            if (null != b2bLogisticsOrderDelivery.get()) {
                columns.add("");
                values.add(b2bLogisticsOrderDelivery.get());
    ...
    public int updateByPrimaryKeySelective(B2bLogisticsOrderDeliveryBean b2bLogisticsOrderDelivery) {
        try {
            ...
            if (null != b2bLogisticsOrderDelivery.getGoodsType()) {
                updateSql.add("goods_type = ?");
                params.add(b2bLogisticsOrderDelivery.getGoodsType());
            }
            if (null != b2bLogisticsOrderDelivery.getOrderPkgId()) {
            ...
            if (null != b2bLogisticsOrderDelivery.get()) {
                updateSql.add(" = ?");
                params.add(b2bLogisticsOrderDelivery.get());
            }
            if (null != b2bLogisticsOrderDelivery.get()) {
                updateSql.add(" = ?");
                params.add(b2bLogisticsOrderDelivery.get());
