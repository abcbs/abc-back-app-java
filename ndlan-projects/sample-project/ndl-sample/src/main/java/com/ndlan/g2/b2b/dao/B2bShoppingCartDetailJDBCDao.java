...
public interface B2bShoppingCartDetailJDBCDao  extends BaseDao<B2bShoppingCartDetailBean, String>{
    /**
     * 根据主键查询
     * @param id 主键id
     ...
     * @param b2bShoppingCartDetail 数据对象
     * @return 成功插入的记录数
     */
    public int insertSelective(B2bShoppingCartDetailBean b2bShoppingCartDetail);

    /**
    * 有选择的插入记录，只插入对象中非null值的字段，并获取主键id到b2bShoppingCartDetail对象中
    * @param b2bShoppingCartDetail 数据对象
    * @return 成功插入的记录数
    */
