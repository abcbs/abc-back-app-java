...
public class B2bProductClientAtomServiceImpl  extends BaseService<B2bProductClientDao, 
	...
	Date updateTime = b2bProductClient.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProductClient.getUpdateTime());
        } 
        ...
        String createBy = b2bProductClient.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProductClient.getCreateBy());
        }
	...
	Date createTime = b2bProductClient.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProductClient.getCreateTime());
        } 
        ...
        String status = b2bProductClient.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bProductClient.getStatus());
        }
        ...
        String updateBy = b2bProductClient.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    
	     param.add(b2bProductClient.getUpdateBy());
        }
    ...
    public B2bProductClientBean trimStringValue(B2bProductClientBean b2bProductClient) {
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bProductClient.setCreateBy(createBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 20) {
            b2bProductClient.setStatus(status.substring(0, 20));
        }
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bProductClient.setUpdateBy(updateBy.substring(0, 36));
        }
