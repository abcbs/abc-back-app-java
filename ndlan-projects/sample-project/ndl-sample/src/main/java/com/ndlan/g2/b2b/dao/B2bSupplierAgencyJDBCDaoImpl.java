...
@Repository("b2bSupplierAgencyJDBCDao")
public class B2bSupplierAgencyJDBCDaoImpl implements B2bSupplierAgencyJDBCDao {
    ...
    public int insertSelective(B2bSupplierAgencyBean b2bSupplierAgency) {
        try {
            ...
            if (null != b2bSupplierAgency.getStatus()) {
                columns.add("status");
                values.add(b2bSupplierAgency.getStatus());
            }
            ...
            if (null != b2bSupplierAgency.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bSupplierAgency.getUpdateTime());
            }
            ...
            if (null != b2bSupplierAgency.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bSupplierAgency.getCreateTime());
            }
            if (null != b2bSupplierAgency.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bSupplierAgency.getCreateBy());
            }
            if (null != b2bSupplierAgency.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bSupplierAgency.getUpdateBy());
            }
    ...
    public int updateByPrimaryKeySelective(B2bSupplierAgencyBean b2bSupplierAgency) {
        try {
            ...
            if (null != b2bSupplierAgency.getStatus()) {
                ...
                params.add(b2bSupplierAgency.getStatus());
            }
            if (null != b2bSupplierAgency.getContactPhone()) {
            ...
            if (null != b2bSupplierAgency.getUpdateTime()) {
                ...
                params.add(b2bSupplierAgency.getUpdateTime());
            }
            if (null != b2bSupplierAgency.getContactUser()) {
            ...
            if (null != b2bSupplierAgency.getCreateTime()) {
                ...
                params.add(b2bSupplierAgency.getCreateTime());
            }
            if (null != b2bSupplierAgency.getCreateBy()) {
                updateSql.add("create_by = ?");
                params.add(b2bSupplierAgency.getCreateBy());
            }
            if (null != b2bSupplierAgency.getUpdateBy()) {
                updateSql.add("update_by = ?");
                params.add(b2bSupplierAgency.getUpdateBy());
            }
            if (null != b2bSupplierAgency.getAgencyName()) {
