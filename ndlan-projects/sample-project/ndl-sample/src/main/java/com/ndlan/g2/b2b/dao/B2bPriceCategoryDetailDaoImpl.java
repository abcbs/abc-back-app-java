...
@Repository("b2bPriceCategoryDetailDao")
public class B2bPriceCategoryDetailDaoImpl implements B2bPriceCategoryDetailDao {
    ...
    public int insertSelective(B2bPriceCategoryDetailBean b2bPriceCategoryDetail) {
        try {
            ...
            if (null != b2bPriceCategoryDetail.get()) {
                columns.add("");
                values.add(b2bPriceCategoryDetail.get());
            }
    ...
    public int updateByPrimaryKeySelective(B2bPriceCategoryDetailBean b2bPriceCategoryDetail) {
        try {
            ...
            if (null != b2bPriceCategoryDetail.get()) {
                updateSql.add(" = ?");
                params.add(b2bPriceCategoryDetail.get());
            }
            if (null != b2bPriceCategoryDetail.getSpecsName()) {
