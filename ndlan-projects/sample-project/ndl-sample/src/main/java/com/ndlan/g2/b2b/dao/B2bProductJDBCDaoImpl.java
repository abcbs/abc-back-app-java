...
@Repository("b2bProductJDBCDao")
public class B2bProductJDBCDaoImpl implements B2bProductJDBCDao {
    ...
    public int insertSelective(B2bProductBean b2bProduct) {
        try {
            ...
            if (null != b2bProduct.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bProduct.getUpdateBy());
            }
            if (null != b2bProduct.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bProduct.getCreateTime());
            }
            ...
            if (null != b2bProduct.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bProduct.getUpdateTime());
            }
            ...
            if (null != b2bProduct.getStatus()) {
                columns.add("status");
                values.add(b2bProduct.getStatus());
            }
            ...
            if (null != b2bProduct.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bProduct.getCreateBy());
            }
    ...
    public int updateByPrimaryKeySelective(B2bProductBean b2bProduct) {
        try {
            ...
            if (null != b2bProduct.getUpdateBy()) {
                ...
                params.add(b2bProduct.getUpdateBy());
            }
            if (null != b2bProduct.getCreateTime()) {
                updateSql.add("create_time = ?");
                params.add(b2bProduct.getCreateTime());
            }
            if (null != b2bProduct.getVolume()) {
            ...
            if (null != b2bProduct.getUpdateTime()) {
                ...
                params.add(b2bProduct.getUpdateTime());
            }
            if (null != b2bProduct.getProDesc()) {
            ...
            if (null != b2bProduct.getStatus()) {
                ...
                params.add(b2bProduct.getStatus());
            }
            if (null != b2bProduct.getSpecsId()) {
            ...
            if (null != b2bProduct.getCreateBy()) {
                ...
                params.add(b2bProduct.getCreateBy());
            }
            if (null != b2bProduct.getProId()) {
