...
@Repository("b2bOrderStatusHisJDBCDao")
public class B2bOrderStatusHisJDBCDaoImpl implements B2bOrderStatusHisJDBCDao {
    ...
    public int insertSelective(B2bOrderStatusHisBean b2bOrderStatusHis) {
        try {
            ...
            if (null != b2bOrderStatusHis.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bOrderStatusHis.getUpdateBy());
            }
            ...
            if (null != b2bOrderStatusHis.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bOrderStatusHis.getCreateTime());
            }
            if (null != b2bOrderStatusHis.getUpdateReason()) {
                columns.add("update_reason");
                values.add(b2bOrderStatusHis.getUpdateReason());
            }
            if (null != b2bOrderStatusHis.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bOrderStatusHis.getCreateBy());
            }
            if (null != b2bOrderStatusHis.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bOrderStatusHis.getUpdateTime());
            }
            if (null != b2bOrderStatusHis.getOrignCreateTime()) {
                columns.add("orign_create_time");
                values.add(b2bOrderStatusHis.getOrignCreateTime());
            }
            if (null != b2bOrderStatusHis.getStatus()) {
                columns.add("status");
                values.add(b2bOrderStatusHis.getStatus());
            }
    ...
    public int updateByPrimaryKeySelective(B2bOrderStatusHisBean b2bOrderStatusHis) {
        try {
            ...
            if (null != b2bOrderStatusHis.getUpdateBy()) {
                ...
                params.add(b2bOrderStatusHis.getUpdateBy());
            }
            if (null != b2bOrderStatusHis.getOrignVersion()) {
            ...
            if (null != b2bOrderStatusHis.getCreateTime()) {
                ...
                params.add(b2bOrderStatusHis.getCreateTime());
            }
            if (null != b2bOrderStatusHis.getUpdateReason()) {
            ...
            if (null != b2bOrderStatusHis.getCreateBy()) {
                ...
                params.add(b2bOrderStatusHis.getCreateBy());
            }
            if (null != b2bOrderStatusHis.getUpdateTime()) {
                updateSql.add("update_time = ?");
                params.add(b2bOrderStatusHis.getUpdateTime());
            }
            if (null != b2bOrderStatusHis.getOrignCreateTime()) {
            ...
            if (null != b2bOrderStatusHis.getStatus()) {
                ...
                params.add(b2bOrderStatusHis.getStatus());
            }
            if (null != b2bOrderStatusHis.getOrderHeadId()) {
