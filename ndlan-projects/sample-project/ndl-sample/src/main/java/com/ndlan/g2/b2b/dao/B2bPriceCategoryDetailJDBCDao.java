...
public interface B2bPriceCategoryDetailJDBCDao  extends BaseDao<B2bPriceCategoryDetailBean, String>{
    /**
     * 根据主键查询
     * @param id 主键id
     ...
     * @param b2bPriceCategoryDetail 数据对象
     * @return 成功插入的记录数
     */
    public int insertSelective(B2bPriceCategoryDetailBean b2bPriceCategoryDetail);

    /**
    * 有选择的插入记录，只插入对象中非null值的字段，并获取主键id到b2bPriceCategoryDetail对象中
    * @param b2bPriceCategoryDetail 数据对象
    * @return 成功插入的记录数
    */
