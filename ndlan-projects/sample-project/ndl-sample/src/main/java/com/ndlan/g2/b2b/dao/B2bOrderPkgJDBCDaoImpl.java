...
@Repository("b2bOrderPkgJDBCDao")
public class B2bOrderPkgJDBCDaoImpl implements B2bOrderPkgJDBCDao {
    ...
    public int insertSelective(B2bOrderPkgBean b2bOrderPkg) {
        try {
            ...
            if (null != b2bOrderPkg.getStatus()) {
                columns.add("status");
                values.add(b2bOrderPkg.getStatus());
            }
            ...
            if (null != b2bOrderPkg.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bOrderPkg.getCreateBy());
            }
            if (null != b2bOrderPkg.getCartId()) {
                columns.add("cart_id");
                values.add(b2bOrderPkg.getCartId());
            }
            if (null != b2bOrderPkg.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bOrderPkg.getCreateTime());
            }
            if (null != b2bOrderPkg.getRemark()) {
                columns.add("remark");
                values.add(b2bOrderPkg.getRemark());
            }
            if (null != b2bOrderPkg.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bOrderPkg.getUpdateBy());
            }
            ...
            if (null != b2bOrderPkg.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bOrderPkg.getUpdateTime());
            }
    ...
    public int updateByPrimaryKeySelective(B2bOrderPkgBean b2bOrderPkg) {
        try {
            ...
            if (null != b2bOrderPkg.getStatus()) {
                ...
                params.add(b2bOrderPkg.getStatus());
            }
            if (null != b2bOrderPkg.getOrderHeadId()) {
            ...
            if (null != b2bOrderPkg.getCreateBy()) {
                ...
                params.add(b2bOrderPkg.getCreateBy());
            }
            if (null != b2bOrderPkg.getCartId()) {
            ...
            if (null != b2bOrderPkg.getCreateTime()) {
                ...
                params.add(b2bOrderPkg.getCreateTime());
            }
            if (null != b2bOrderPkg.getRemark()) {
            ...
            if (null != b2bOrderPkg.getUpdateBy()) {
                ...
                params.add(b2bOrderPkg.getUpdateBy());
            }
            if (null != b2bOrderPkg.getOrderPkgCode()) {
            ...
            if (null != b2bOrderPkg.getUpdateTime()) {
                ...
                params.add(b2bOrderPkg.getUpdateTime());
            }
            if (null != b2bOrderPkg.getSlsPmtnId()) {
