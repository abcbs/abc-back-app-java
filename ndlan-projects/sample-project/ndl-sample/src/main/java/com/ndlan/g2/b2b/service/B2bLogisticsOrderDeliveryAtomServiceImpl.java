...
public class B2bLogisticsOrderDeliveryAtomServiceImpl  extends BaseService<B2bLogisticsOrderDeliveryDao, 
	...
	SQLParam sqlParam=new SQLParam();
        ...
        String updateBy = b2bLogisticsOrderDelivery.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bLogisticsOrderDelivery.getUpdateBy());
        }
	...
	Date updateTime = b2bLogisticsOrderDelivery.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bLogisticsOrderDelivery.getUpdateTime());
        } 
	...
	Date createTime = b2bLogisticsOrderDelivery.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bLogisticsOrderDelivery.getCreateTime());
        } 
	...
	if (orderDate!=null  ) {
        ...
        String status = b2bLogisticsOrderDelivery.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bLogisticsOrderDelivery.getStatus());
        }
        ...
        String createBy = b2bLogisticsOrderDelivery.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bLogisticsOrderDelivery.getCreateBy());
        }
    ...
    public B2bLogisticsOrderDeliveryBean trimStringValue(B2bLogisticsOrderDeliveryBean b2bLogisticsOrderDelivery) {
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bLogisticsOrderDelivery.setUpdateBy(updateBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 2) {
            b2bLogisticsOrderDelivery.setStatus(status.substring(0, 2));
        }
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bLogisticsOrderDelivery.setCreateBy(createBy.substring(0, 36));
        }
