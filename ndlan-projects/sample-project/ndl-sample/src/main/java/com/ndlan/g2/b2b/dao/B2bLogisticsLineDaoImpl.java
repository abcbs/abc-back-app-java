...
@Repository("b2bLogisticsLineDao")
public class B2bLogisticsLineDaoImpl implements B2bLogisticsLineDao {
    ...
    public int insertSelective(B2bLogisticsLineBean b2bLogisticsLine) {
        try {
            ...
            if (null != b2bLogisticsLine.get()) {
                columns.add("");
                values.add(b2bLogisticsLine.get());
            }
    ...
    public int updateByPrimaryKeySelective(B2bLogisticsLineBean b2bLogisticsLine) {
        try {
            ...
            if (null != b2bLogisticsLine.get()) {
                updateSql.add(" = ?");
                params.add(b2bLogisticsLine.get());
            }
            if (null != b2bLogisticsLine.getLogisticsLineId()) {
