...
public class B2bInventoryStorageAtomServiceImpl  extends BaseService<B2bInventoryStorageDao, 
	...
	SQLParam sqlParam=new SQLParam();
        ...
        String createBy = b2bInventoryStorage.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bInventoryStorage.getCreateBy());
        }
	...
	Date createTime = b2bInventoryStorage.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bInventoryStorage.getCreateTime());
        } 
	...
	Date updateTime = b2bInventoryStorage.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bInventoryStorage.getUpdateTime());
        } 
	...
	if (storageDate!=null  ) {
        ...
        String updateBy = b2bInventoryStorage.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bInventoryStorage.getUpdateBy());
        }
    ...
    public B2bInventoryStorageBean trimStringValue(B2bInventoryStorageBean b2bInventoryStorage) {
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bInventoryStorage.setCreateBy(createBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bInventoryStorage.setUpdateBy(updateBy.substring(0, 36));
        }
