...
@Repository("b2bOrderRmtDetailDao")
public class B2bOrderRmtDetailDaoImpl implements B2bOrderRmtDetailDao {
    ...
    public int insertSelective(B2bOrderRmtDetailBean b2bOrderRmtDetail) {
        try {
            ...
            if (null != b2bOrderRmtDetail.get()) {
                columns.add("");
                values.add(b2bOrderRmtDetail.get());
            }
            ...
            if (null != b2bOrderRmtDetail.getApplDesc()) {
                columns.add("appl_desc");
                values.add(b2bOrderRmtDetail.getApplDesc());
            }
            ...
            if (null != b2bOrderRmtDetail.getPrice()) {
                columns.add("price");
                values.add(b2bOrderRmtDetail.getPrice());
            }
    ...
    public int updateByPrimaryKeySelective(B2bOrderRmtDetailBean b2bOrderRmtDetail) {
        try {
            ...
            if (null != b2bOrderRmtDetail.get()) {
                updateSql.add(" = ?");
                params.add(b2bOrderRmtDetail.get());
            }
            if (null != b2bOrderRmtDetail.getCategoryName()) {
            ...
            if (null != b2bOrderRmtDetail.getApplDesc()) {
                ...
                params.add(b2bOrderRmtDetail.getApplDesc());
            }
            if (null != b2bOrderRmtDetail.getRestName()) {
            ...
            if (null != b2bOrderRmtDetail.getPrice()) {
                updateSql.add("price = ?");
                params.add(b2bOrderRmtDetail.getPrice());
            }
            if (null != b2bOrderRmtDetail.getProName()) {
