...
public class B2bSupplierAgencyAtomServiceImpl  extends BaseService<B2bSupplierAgencyDao, 
	...
	SQLParam sqlParam=new SQLParam();
        String createBy = b2bSupplierAgency.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierAgency.getCreateBy());
        }
        ...
        String updateBy = b2bSupplierAgency.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierAgency.getUpdateBy());
        }
      
            
	Date updateTime = b2bSupplierAgency.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierAgency.getUpdateTime());
        } 
	...
	Date createTime = b2bSupplierAgency.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierAgency.getCreateTime());
        } 
        ...
        String status = b2bSupplierAgency.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    
	     param.add(b2bSupplierAgency.getStatus());
        }
    ...
    public B2bSupplierAgencyBean trimStringValue(B2bSupplierAgencyBean b2bSupplierAgency) {
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bSupplierAgency.setCreateBy(createBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bSupplierAgency.setUpdateBy(updateBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 2) {
            b2bSupplierAgency.setStatus(status.substring(0, 2));
        }
