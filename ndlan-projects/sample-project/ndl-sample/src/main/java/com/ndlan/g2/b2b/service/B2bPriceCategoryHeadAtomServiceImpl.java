...
public class B2bPriceCategoryHeadAtomServiceImpl  extends BaseService<B2bPriceCategoryHeadDao, 
	...
	Date updateTime = b2bPriceCategoryHead.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryHead.getUpdateTime());
        } 
      
            
	Date createTime = b2bPriceCategoryHead.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryHead.getCreateTime());
        } 
        ...
        String updateBy = b2bPriceCategoryHead.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryHead.getUpdateBy());
        }
        ...
        String createBy = b2bPriceCategoryHead.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryHead.getCreateBy());
        }
        ...
        String status = b2bPriceCategoryHead.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryHead.getStatus());
        }
    ...
    public B2bPriceCategoryHeadBean trimStringValue(B2bPriceCategoryHeadBean b2bPriceCategoryHead) {
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bPriceCategoryHead.setUpdateBy(updateBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bPriceCategoryHead.setCreateBy(createBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 20) {
            b2bPriceCategoryHead.setStatus(status.substring(0, 20));
        }
