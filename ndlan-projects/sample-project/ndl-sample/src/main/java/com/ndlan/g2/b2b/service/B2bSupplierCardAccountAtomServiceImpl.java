...
public class B2bSupplierCardAccountAtomServiceImpl  extends BaseService<B2bSupplierCardAccountDao, 
	...
	Date updateTime = b2bSupplierCardAccount.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierCardAccount.getUpdateTime());
        } 
        ...
        String status = b2bSupplierCardAccount.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierCardAccount.getStatus());
        }
        ...
        String updateBy = b2bSupplierCardAccount.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierCardAccount.getUpdateBy());
        }
	...
	Date createTime = b2bSupplierCardAccount.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierCardAccount.getCreateTime());
        } 
        ...
        String createBy = b2bSupplierCardAccount.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bSupplierCardAccount.getCreateBy());
        }
    ...
    public B2bSupplierCardAccountBean trimStringValue(B2bSupplierCardAccountBean b2bSupplierCardAccount) {
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 2) {
            b2bSupplierCardAccount.setStatus(status.substring(0, 2));
        }
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bSupplierCardAccount.setUpdateBy(updateBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bSupplierCardAccount.setCreateBy(createBy.substring(0, 36));
        }
