...
public interface B2bDeliveryAddressJDBCDao  extends BaseDao<B2bDeliveryAddressBean, String>{
    /**
     * 根据主键查询
     * @param id 主键id
     ...
     * @param b2bDeliveryAddress 数据对象
     * @return 成功插入的记录数
     */
    public int insertSelective(B2bDeliveryAddressBean b2bDeliveryAddress);

    /**
    * 有选择的插入记录，只插入对象中非null值的字段，并获取主键id到b2bDeliveryAddress对象中
    * @param b2bDeliveryAddress 数据对象
    * @return 成功插入的记录数
    */
