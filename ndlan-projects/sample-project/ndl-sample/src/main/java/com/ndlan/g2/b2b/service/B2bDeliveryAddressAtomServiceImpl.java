...
public class B2bDeliveryAddressAtomServiceImpl  extends BaseService<B2bDeliveryAddressDao, 
	...
	Date updateTime = b2bDeliveryAddress.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bDeliveryAddress.getUpdateTime());
        } 
      
            
	Date createTime = b2bDeliveryAddress.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bDeliveryAddress.getCreateTime());
        } 
        ...
        String status = b2bDeliveryAddress.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bDeliveryAddress.getStatus());
        }
        ...
        String createBy = b2bDeliveryAddress.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bDeliveryAddress.getCreateBy());
        }
      
            
        String updateBy = b2bDeliveryAddress.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    
	     param.add(b2bDeliveryAddress.getUpdateBy());
        }
    ...
    public B2bDeliveryAddressBean trimStringValue(B2bDeliveryAddressBean b2bDeliveryAddress) {
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 2) {
            b2bDeliveryAddress.setStatus(status.substring(0, 2));
        }
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bDeliveryAddress.setCreateBy(createBy.substring(0, 36));
        }

        String updateBy = b2bDeliveryAddress.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bDeliveryAddress.setUpdateBy(updateBy.substring(0, 36));
        }
