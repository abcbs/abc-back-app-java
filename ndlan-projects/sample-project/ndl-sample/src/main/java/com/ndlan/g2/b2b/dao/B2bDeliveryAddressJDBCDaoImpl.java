...
@Repository("b2bDeliveryAddressJDBCDao")
public class B2bDeliveryAddressJDBCDaoImpl implements B2bDeliveryAddressJDBCDao {
    ...
    public int insertSelective(B2bDeliveryAddressBean b2bDeliveryAddress) {
        try {
            ...
            if (null != b2bDeliveryAddress.getStatus()) {
                columns.add("status");
                values.add(b2bDeliveryAddress.getStatus());
            }
            if (null != b2bDeliveryAddress.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bDeliveryAddress.getCreateBy());
            }
            ...
            if (null != b2bDeliveryAddress.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bDeliveryAddress.getCreateTime());
            }
            if (null != b2bDeliveryAddress.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bDeliveryAddress.getUpdateBy());
            }
            if (null != b2bDeliveryAddress.getSupplierId()) {
                columns.add("supplier_id");
                values.add(b2bDeliveryAddress.getSupplierId());
            }
            if (null != b2bDeliveryAddress.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bDeliveryAddress.getUpdateTime());
            }
    ...
    public int updateByPrimaryKeySelective(B2bDeliveryAddressBean b2bDeliveryAddress) {
        try {
            ...
            if (null != b2bDeliveryAddress.getStatus()) {
                ...
                params.add(b2bDeliveryAddress.getStatus());
            }
            if (null != b2bDeliveryAddress.getCreateBy()) {
                updateSql.add("create_by = ?");
                params.add(b2bDeliveryAddress.getCreateBy());
            }
            if (null != b2bDeliveryAddress.getReceiveName()) {
            ...
            if (null != b2bDeliveryAddress.getCreateTime()) {
                ...
                params.add(b2bDeliveryAddress.getCreateTime());
            }
            if (null != b2bDeliveryAddress.getUpdateBy()) {
                updateSql.add("update_by = ?");
                params.add(b2bDeliveryAddress.getUpdateBy());
            }
            if (null != b2bDeliveryAddress.getSupplierId()) {
            ...
            if (null != b2bDeliveryAddress.getUpdateTime()) {
                ...
                params.add(b2bDeliveryAddress.getUpdateTime());
            }
            if (null != b2bDeliveryAddress.getRemake()) {
