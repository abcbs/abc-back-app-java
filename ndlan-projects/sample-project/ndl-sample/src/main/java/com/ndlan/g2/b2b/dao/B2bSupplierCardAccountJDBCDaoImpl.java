...
@Repository("b2bSupplierCardAccountJDBCDao")
public class B2bSupplierCardAccountJDBCDaoImpl implements B2bSupplierCardAccountJDBCDao {
    ...
    public int insertSelective(B2bSupplierCardAccountBean b2bSupplierCardAccount) {
        try {
            ...
            if (null != b2bSupplierCardAccount.getStatus()) {
                columns.add("status");
                values.add(b2bSupplierCardAccount.getStatus());
            }
            if (null != b2bSupplierCardAccount.getSubbranch()) {
                columns.add("subbranch");
                values.add(b2bSupplierCardAccount.getSubbranch());
            }
            if (null != b2bSupplierCardAccount.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bSupplierCardAccount.getUpdateTime());
            }
            ...
            if (null != b2bSupplierCardAccount.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bSupplierCardAccount.getUpdateBy());
            }
            ...
            if (null != b2bSupplierCardAccount.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bSupplierCardAccount.getCreateTime());
            }
            if (null != b2bSupplierCardAccount.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bSupplierCardAccount.getCreateBy());
            }
    ...
    public int updateByPrimaryKeySelective(B2bSupplierCardAccountBean b2bSupplierCardAccount) {
        try {
            ...
            if (null != b2bSupplierCardAccount.getStatus()) {
                ...
                params.add(b2bSupplierCardAccount.getStatus());
            }
            if (null != b2bSupplierCardAccount.getSubbranch()) {
            ...
            if (null != b2bSupplierCardAccount.getUpdateTime()) {
                ...
                params.add(b2bSupplierCardAccount.getUpdateTime());
            }
            if (null != b2bSupplierCardAccount.getCardNo()) {
            ...
            if (null != b2bSupplierCardAccount.getUpdateBy()) {
                ...
                params.add(b2bSupplierCardAccount.getUpdateBy());
            }
            if (null != b2bSupplierCardAccount.getCardinfoSummay()) {
            ...
            if (null != b2bSupplierCardAccount.getCreateTime()) {
                ...
                params.add(b2bSupplierCardAccount.getCreateTime());
            }
            if (null != b2bSupplierCardAccount.getCreateBy()) {
                updateSql.add("create_by = ?");
                params.add(b2bSupplierCardAccount.getCreateBy());
            }
            if (null != b2bSupplierCardAccount.getPhoneNo()) {
