...
@Repository("b2bInventoryDeliveryDao")
public class B2bInventoryDeliveryDaoImpl implements B2bInventoryDeliveryDao {
    ...
    public int insertSelective(B2bInventoryDeliveryBean b2bInventoryDelivery) {
        try {
            ...
            if (null != b2bInventoryDelivery.get()) {
                columns.add("");
                values.add(b2bInventoryDelivery.get());
            }
            if (null != b2bInventoryDelivery.get()) {
                columns.add("");
                values.add(b2bInventoryDelivery.get());
    ...
    public int updateByPrimaryKeySelective(B2bInventoryDeliveryBean b2bInventoryDelivery) {
        try {
            ...
            if (null != b2bInventoryDelivery.get()) {
                updateSql.add(" = ?");
                params.add(b2bInventoryDelivery.get());
            }
            if (null != b2bInventoryDelivery.get()) {
                updateSql.add(" = ?");
                params.add(b2bInventoryDelivery.get());
