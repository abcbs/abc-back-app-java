...
@Repository("b2bOrderJDBCDao")
public class B2bOrderJDBCDaoImpl implements B2bOrderJDBCDao {
    ...
    public int insertSelective(B2bOrderBean b2bOrder) {
        try {
            ...
            if (null != b2bOrder.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bOrder.getCreateBy());
            }
            if (null != b2bOrder.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bOrder.getUpdateBy());
            }
            ...
            if (null != b2bOrder.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bOrder.getCreateTime());
            }
            ...
            if (null != b2bOrder.getStatus()) {
                columns.add("status");
                values.add(b2bOrder.getStatus());
            }
            ...
            if (null != b2bOrder.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bOrder.getUpdateTime());
            }
    ...
    public int updateByPrimaryKeySelective(B2bOrderBean b2bOrder) {
        try {
            ...
            if (null != b2bOrder.getCreateBy()) {
                ...
                params.add(b2bOrder.getCreateBy());
            }
            if (null != b2bOrder.getUpdateBy()) {
                updateSql.add("update_by = ?");
                params.add(b2bOrder.getUpdateBy());
            }
            if (null != b2bOrder.getAmountPaid()) {
            ...
            if (null != b2bOrder.getCreateTime()) {
                ...
                params.add(b2bOrder.getCreateTime());
            }
            if (null != b2bOrder.getRestName()) {
            ...
            if (null != b2bOrder.getUpdateTime()) {
                ...
                params.add(b2bOrder.getUpdateTime());
            }
