...
@Repository("b2bOrderRmtPkgJDBCDao")
public class B2bOrderRmtPkgJDBCDaoImpl implements B2bOrderRmtPkgJDBCDao {
    ...
    public int insertSelective(B2bOrderRmtPkgBean b2bOrderRmtPkg) {
        try {
            ...
            if (null != b2bOrderRmtPkg.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bOrderRmtPkg.getCreateBy());
            }
            ...
            if (null != b2bOrderRmtPkg.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bOrderRmtPkg.getUpdateTime());
            }
            if (null != b2bOrderRmtPkg.getOrderRmtPkgId()) {
                columns.add("order_rmt_pkg_id");
                values.add(b2bOrderRmtPkg.getOrderRmtPkgId());
            }
            if (null != b2bOrderRmtPkg.getStatus()) {
                columns.add("status");
                values.add(b2bOrderRmtPkg.getStatus());
            }
            if (null != b2bOrderRmtPkg.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bOrderRmtPkg.getUpdateBy());
            }
            ...
            if (null != b2bOrderRmtPkg.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bOrderRmtPkg.getCreateTime());
            }
    ...
    public int updateByPrimaryKeySelective(B2bOrderRmtPkgBean b2bOrderRmtPkg) {
        try {
            ...
            if (null != b2bOrderRmtPkg.getCreateBy()) {
                ...
                params.add(b2bOrderRmtPkg.getCreateBy());
            }
            if (null != b2bOrderRmtPkg.getCartId()) {
            ...
            if (null != b2bOrderRmtPkg.getUpdateTime()) {
                ...
                params.add(b2bOrderRmtPkg.getUpdateTime());
            }
            if (null != b2bOrderRmtPkg.getOrderRmtPkgId()) {
            ...
            if (null != b2bOrderRmtPkg.getStatus()) {
                ...
                params.add(b2bOrderRmtPkg.getStatus());
            }
            if (null != b2bOrderRmtPkg.getUpdateBy()) {
                updateSql.add("update_by = ?");
                params.add(b2bOrderRmtPkg.getUpdateBy());
            }
            if (null != b2bOrderRmtPkg.getOrderPkgCode()) {
            ...
            if (null != b2bOrderRmtPkg.getCreateTime()) {
                ...
                params.add(b2bOrderRmtPkg.getCreateTime());
            }
            if (null != b2bOrderRmtPkg.getOrderPkgId()) {
