...
@Repository("b2bShoppingCartDao")
public class B2bShoppingCartDaoImpl implements B2bShoppingCartDao {
    ...
    public int insertSelective(B2bShoppingCartBean b2bShoppingCart) {
        try {
            ...
            if (null != b2bShoppingCart.get()) {
                columns.add("");
                values.add(b2bShoppingCart.get());
            }
    ...
    public int updateByPrimaryKeySelective(B2bShoppingCartBean b2bShoppingCart) {
        try {
            ...
            if (null != b2bShoppingCart.get()) {
                updateSql.add(" = ?");
                params.add(b2bShoppingCart.get());
            }
            if (null != b2bShoppingCart.getCustomerName()) {
