...
public interface B2bSupplierAgencyJDBCDao  extends BaseDao<B2bSupplierAgencyBean, String>{
    /**
     * 根据主键查询
     * @param id 主键id
     ...
     * @param b2bSupplierAgency 数据对象
     * @return 成功插入的记录数
     */
    public int insertSelective(B2bSupplierAgencyBean b2bSupplierAgency);

    /**
    * 有选择的插入记录，只插入对象中非null值的字段，并获取主键id到b2bSupplierAgency对象中
    * @param b2bSupplierAgency 数据对象
    * @return 成功插入的记录数
    */
