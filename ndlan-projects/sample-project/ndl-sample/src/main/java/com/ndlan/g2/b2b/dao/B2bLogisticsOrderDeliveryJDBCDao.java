...
public interface B2bLogisticsOrderDeliveryJDBCDao  extends BaseDao<B2bLogisticsOrderDeliveryBean, String>{
    /**
     * 根据主键查询
     * @param id 主键id
    ...
    /**
    * 有选择的插入记录，只插入对象中非null值的字段，并获取主键id到b2bLogisticsOrderDelivery对象中
    * @param b2bLogisticsOrderDelivery 数据对象
    * @return 成功插入的记录数
    */
