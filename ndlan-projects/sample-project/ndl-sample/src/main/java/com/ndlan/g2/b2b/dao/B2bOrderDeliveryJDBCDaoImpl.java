...
@Repository("b2bOrderDeliveryJDBCDao")
public class B2bOrderDeliveryJDBCDaoImpl implements B2bOrderDeliveryJDBCDao {
    ...
    public int insertSelective(B2bOrderDeliveryBean b2bOrderDelivery) {
        try {
            ...
            if (null != b2bOrderDelivery.getCreateBy()) {
                columns.add("create_by");
                values.add(b2bOrderDelivery.getCreateBy());
            }
            ...
            if (null != b2bOrderDelivery.getUpdateBy()) {
                columns.add("update_by");
                values.add(b2bOrderDelivery.getUpdateBy());
            }
            ...
            if (null != b2bOrderDelivery.getCreateTime()) {
                columns.add("create_time");
                values.add(b2bOrderDelivery.getCreateTime());
            }
            ...
            if (null != b2bOrderDelivery.getStatus()) {
                columns.add("status");
                values.add(b2bOrderDelivery.getStatus());
            }
            if (null != b2bOrderDelivery.getRemake()) {
                columns.add("remake");
                values.add(b2bOrderDelivery.getRemake());
            }
            if (null != b2bOrderDelivery.getUpdateTime()) {
                columns.add("update_time");
                values.add(b2bOrderDelivery.getUpdateTime());
            }
    ...
    public int updateByPrimaryKeySelective(B2bOrderDeliveryBean b2bOrderDelivery) {
        try {
            ...
            if (null != b2bOrderDelivery.getCreateBy()) {
                ...
                params.add(b2bOrderDelivery.getCreateBy());
            }
            if (null != b2bOrderDelivery.getOrderPkgCode()) {
            ...
            if (null != b2bOrderDelivery.getUpdateBy()) {
                ...
                params.add(b2bOrderDelivery.getUpdateBy());
            }
            if (null != b2bOrderDelivery.getSupplierName()) {
            ...
            if (null != b2bOrderDelivery.getCreateTime()) {
                ...
                params.add(b2bOrderDelivery.getCreateTime());
            }
            if (null != b2bOrderDelivery.getDeliveryAddressId()) {
            ...
            if (null != b2bOrderDelivery.getStatus()) {
                ...
                params.add(b2bOrderDelivery.getStatus());
            }
            if (null != b2bOrderDelivery.getRemake()) {
            ...
            if (null != b2bOrderDelivery.getUpdateTime()) {
                ...
                params.add(b2bOrderDelivery.getUpdateTime());
            }
