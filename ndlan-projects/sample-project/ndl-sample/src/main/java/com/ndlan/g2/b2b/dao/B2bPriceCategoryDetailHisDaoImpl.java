...
@Repository("b2bPriceCategoryDetailHisDao")
public class B2bPriceCategoryDetailHisDaoImpl implements B2bPriceCategoryDetailHisDao {
    ...
    public int insertSelective(B2bPriceCategoryDetailHisBean b2bPriceCategoryDetailHis) {
        try {
            ...
            if (null != b2bPriceCategoryDetailHis.get()) {
                columns.add("");
                values.add(b2bPriceCategoryDetailHis.get());
            }
            if (null != b2bPriceCategoryDetailHis.get()) {
                columns.add("");
                values.add(b2bPriceCategoryDetailHis.get());
    ...
    public int updateByPrimaryKeySelective(B2bPriceCategoryDetailHisBean b2bPriceCategoryDetailHis) {
        try {
            ...
            if (null != b2bPriceCategoryDetailHis.get()) {
                updateSql.add(" = ?");
                params.add(b2bPriceCategoryDetailHis.get());
            }
            if (null != b2bPriceCategoryDetailHis.get()) {
                updateSql.add(" = ?");
                params.add(b2bPriceCategoryDetailHis.get());
