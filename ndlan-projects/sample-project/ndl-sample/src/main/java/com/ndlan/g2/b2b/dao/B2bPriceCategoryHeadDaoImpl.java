...
@Repository("b2bPriceCategoryHeadDao")
public class B2bPriceCategoryHeadDaoImpl implements B2bPriceCategoryHeadDao {
    ...
    public int insertSelective(B2bPriceCategoryHeadBean b2bPriceCategoryHead) {
        try {
            ...
            if (null != b2bPriceCategoryHead.get()) {
                columns.add("");
                values.add(b2bPriceCategoryHead.get());
            }
            ...
            if (null != b2bPriceCategoryHead.getParentIdPath()) {
                columns.add("parent_id_path");
                values.add(b2bPriceCategoryHead.getParentIdPath());
            }
            if (null != b2bPriceCategoryHead.getProColorNo()) {
                columns.add("pro_color_no");
                values.add(b2bPriceCategoryHead.getProColorNo());
            }
            if (null != b2bPriceCategoryHead.getParentNamePath()) {
                columns.add("parent_name_path");
                values.add(b2bPriceCategoryHead.getParentNamePath());
            }
            ...
            if (null != b2bPriceCategoryHead.getPrice()) {
                columns.add("price");
                values.add(b2bPriceCategoryHead.getPrice());
            }
            if (null != b2bPriceCategoryHead.get()) {
                columns.add("");
                values.add(b2bPriceCategoryHead.get());
    ...
    public int updateByPrimaryKeySelective(B2bPriceCategoryHeadBean b2bPriceCategoryHead) {
        try {
            ...
            if (null != b2bPriceCategoryHead.get()) {
                updateSql.add(" = ?");
                params.add(b2bPriceCategoryHead.get());
            }
            if (null != b2bPriceCategoryHead.getSpecsName()) {
            ...
            if (null != b2bPriceCategoryHead.getParentIdPath()) {
                ...
                params.add(b2bPriceCategoryHead.getParentIdPath());
            }
            if (null != b2bPriceCategoryHead.getProColorNo()) {
            ...
            if (null != b2bPriceCategoryHead.getParentNamePath()) {
                ...
                params.add(b2bPriceCategoryHead.getParentNamePath());
            }
            if (null != b2bPriceCategoryHead.getRemarks()) {
            ...
            if (null != b2bPriceCategoryHead.getPrice()) {
                updateSql.add("price = ?");
                params.add(b2bPriceCategoryHead.getPrice());
            }
            if (null != b2bPriceCategoryHead.get()) {
                updateSql.add(" = ?");
                params.add(b2bPriceCategoryHead.get());
