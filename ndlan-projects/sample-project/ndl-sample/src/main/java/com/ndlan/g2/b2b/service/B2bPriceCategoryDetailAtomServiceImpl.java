...
public class B2bPriceCategoryDetailAtomServiceImpl  extends BaseService<B2bPriceCategoryDetailDao, 
	...
	Date createTime = b2bPriceCategoryDetail.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryDetail.getCreateTime());
        } 
	...
	if (effectiveDate!=null  ) {
        ...
        String updateBy = b2bPriceCategoryDetail.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryDetail.getUpdateBy());
        }
	...
	Date updateTime = b2bPriceCategoryDetail.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryDetail.getUpdateTime());
        } 
        ...
        String status = b2bPriceCategoryDetail.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryDetail.getStatus());
        }
        ...
        String createBy = b2bPriceCategoryDetail.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bPriceCategoryDetail.getCreateBy());
        }
    ...
    public B2bPriceCategoryDetailBean trimStringValue(B2bPriceCategoryDetailBean b2bPriceCategoryDetail) {
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bPriceCategoryDetail.setUpdateBy(updateBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 20) {
            b2bPriceCategoryDetail.setStatus(status.substring(0, 20));
        }
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bPriceCategoryDetail.setCreateBy(createBy.substring(0, 36));
        }
