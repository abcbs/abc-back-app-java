...
public class B2bOrderDeliveryAtomServiceImpl  extends BaseService<B2bOrderDeliveryDao, 
	...
	Date updateTime = b2bOrderDelivery.getUpdateTime();
	if (updateTime!=null  ) {
           sqlBuffer.append("updateTime=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bOrderDelivery.getUpdateTime());
        } 
        ...
        String createBy = b2bOrderDelivery.getCreateBy();
        if (StringUtils.isNotBlank(createBy) ) {
           sqlBuffer.append("createBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bOrderDelivery.getCreateBy());
        }
        ...
        String status = b2bOrderDelivery.getStatus();
        if (StringUtils.isNotBlank(status) ) {
           sqlBuffer.append("status=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bOrderDelivery.getStatus());
        }
        ...
        String updateBy = b2bOrderDelivery.getUpdateBy();
        if (StringUtils.isNotBlank(updateBy) ) {
           sqlBuffer.append("updateBy=?");
	    sqlBuffer.append(" and ");
	     param.add(b2bOrderDelivery.getUpdateBy());
        }
	...
	Date createTime = b2bOrderDelivery.getCreateTime();
	if (createTime!=null  ) {
           sqlBuffer.append("createTime=?");
	    
	     param.add(b2bOrderDelivery.getCreateTime());
        } 
    ...
    public B2bOrderDeliveryBean trimStringValue(B2bOrderDeliveryBean b2bOrderDelivery) {
        ...
        if (StringUtils.isNotBlank(createBy) && createBy.length() > 36) {
            b2bOrderDelivery.setCreateBy(createBy.substring(0, 36));
        }
        ...
        if (StringUtils.isNotBlank(status) && status.length() > 2) {
            b2bOrderDelivery.setStatus(status.substring(0, 2));
        }
        ...
        if (StringUtils.isNotBlank(updateBy) && updateBy.length() > 36) {
            b2bOrderDelivery.setUpdateBy(updateBy.substring(0, 36));
        }
