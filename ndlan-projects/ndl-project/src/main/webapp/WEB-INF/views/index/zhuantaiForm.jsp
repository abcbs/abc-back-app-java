...
function changePopTableArea(searchParams,page)
{
	...
	left = parseInt(left.replaceAll("px",""));
	var id = $("#oldTabId").val();
	var thisUrl = '${ctx}/index/pop/zhuantai/'+id+'?left='+left+'&page='+page+'&'+searchParams;
...
<body>
<form id="popSaveForm" action="${ctx}/index/zhuantai/update" method="post" >
		...
		<div class="popup_body">
			...
			<div class="kexuan">
				<c:forEach items="${tables.content}" var="table" varStatus="status">
					<div class="kongxian"  id="${table.tabId}" tabNo="${table.tabNo}">
						<span class="zhuozi">${table.tabName}</span>
