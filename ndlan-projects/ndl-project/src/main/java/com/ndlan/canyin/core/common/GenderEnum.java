...
import java.io.PrintStream;
 ...
 public enum GenderEnum
 {
   ...
   public static final String enumCode = "Gender";
   public static final String enumName = "性别";
   private String code;
   private String desc;
 
   private GenderEnum(String code, String desc) { this.code = code;
     this.desc = desc; }
   ...
   public static void generateSQL()
   {
     ...
     for (GenderEnum status : values()) {
       ...
       String itemSql = "insert into md_base_code_item (bci_id,bc_id,bc_code,bci_code,bci_name,bci_desc,is_enable,version) VALUES ( '" + 
         sub_uuid + "' , '" + uuid + "' ,'" + "Gender" + "', '" + status.getCode() + "','" + status.getDesc() + "','" + status.getDesc() + "','1',0); ";
