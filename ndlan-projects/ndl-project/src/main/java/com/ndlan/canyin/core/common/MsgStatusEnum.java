...
import java.io.PrintStream;
 ...
 public enum MsgStatusEnum
 {
   ...
   public static final String enumCode = "MsgStatus";
   public static final String enumName = "消息状态";
   private String code;
   private String desc;
 
   private MsgStatusEnum(String code, String desc) { this.code = code;
     this.desc = desc; }
 
   public static String getDesc(String code)
   {
     for (MsgStatusEnum status : values()) {
   ...
   public static void generateSQL()
   {
     ...
     for (MsgStatusEnum status : values()) {
       ...
       String itemSql = "insert into md_base_code_item (bci_id,bc_id,bc_code,bci_code,bci_name,bci_desc,is_enable,version) VALUES ( '" + 
         sub_uuid + "' , '" + uuid + "' ,'" + "MsgStatus" + "', '" + status.getCode() + "','" + status.getDesc() + "','" + status.getDesc() + "','1',0); ";
