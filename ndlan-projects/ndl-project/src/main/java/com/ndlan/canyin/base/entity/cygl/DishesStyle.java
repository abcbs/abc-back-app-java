...
import org.hibernate.annotations.GenericGenerator;
 ...
 @Entity
 @Table(name="cm_dishes_style")
 public class DishesStyle extends BaseEntity
   implements Serializable
 {
   ...
   @Column(name="dashes_style_id", unique=true, nullable=false, length=36)
   private String dashesStyleId;
 
   @Column(name="code", length=64)
   private String code;
 
   @Column(name="style_type", length=64)
   ...
   public String getDashesStyleId()
   {
     return this.dashesStyleId;
   }
 
   public void setDashesStyleId(String dashesStyleId) {
     this.dashesStyleId = dashesStyleId;
   }
