...
import com.ndlan.ieream.query.CmStorageDetailsQuery;
import com.ndlan.ieream.model.CmStorageDetailsBean;

public class CmStorageDetailsBeanBustinessRestfulTest {
	
	CmStorageDetailsBeanBustinessRestful productCatatoryBustinessRestful=
			new CmStorageDetailsBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmStorageDetailsBean entity=new CmStorageDetailsBean();
		//todo
	...
	public void selectList() {
		CmStorageDetailsQuery entity=new CmStorageDetailsQuery();
		//todo
