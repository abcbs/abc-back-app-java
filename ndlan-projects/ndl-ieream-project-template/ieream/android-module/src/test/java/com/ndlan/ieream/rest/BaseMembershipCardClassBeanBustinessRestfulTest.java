...
import com.ndlan.ieream.query.BaseMembershipCardClassQuery;
import com.ndlan.ieream.model.BaseMembershipCardClassBean;

public class BaseMembershipCardClassBeanBustinessRestfulTest {
	
	BaseMembershipCardClassBeanBustinessRestful productCatatoryBustinessRestful=
			new BaseMembershipCardClassBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		BaseMembershipCardClassBean entity=new BaseMembershipCardClassBean();
		//todo
	...
	public void selectList() {
		BaseMembershipCardClassQuery entity=new BaseMembershipCardClassQuery();
		//todo
