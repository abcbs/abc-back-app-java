...
import com.ndlan.ieream.query.CmDinerBillCreditPaymentQuery;
import com.ndlan.ieream.model.CmDinerBillCreditPaymentBean;

public class CmDinerBillCreditPaymentBeanBustinessRestfulTest {
	
	CmDinerBillCreditPaymentBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDinerBillCreditPaymentBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDinerBillCreditPaymentBean entity=new CmDinerBillCreditPaymentBean();
		//todo
	...
	public void selectList() {
		CmDinerBillCreditPaymentQuery entity=new CmDinerBillCreditPaymentQuery();
		//todo
