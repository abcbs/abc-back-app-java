...
import com.ndlan.ieream.query.CwCommentQuery;
import com.ndlan.ieream.model.CwCommentBean;

public class CwCommentBeanBustinessRestfulTest {
	
	CwCommentBeanBustinessRestful productCatatoryBustinessRestful=
			new CwCommentBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwCommentBean entity=new CwCommentBean();
		//todo
	...
	public void selectList() {
		CwCommentQuery entity=new CwCommentQuery();
		//todo
