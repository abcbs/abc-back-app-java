...
import com.ndlan.ieream.query.CmSelfOrderQuery;
import com.ndlan.ieream.model.CmSelfOrderBean;

public class CmSelfOrderBeanBustinessRestfulTest {
	
	CmSelfOrderBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSelfOrderBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSelfOrderBean entity=new CmSelfOrderBean();
		//todo
	...
	public void selectList() {
		CmSelfOrderQuery entity=new CmSelfOrderQuery();
		//todo
