...
import com.ndlan.ieream.query.Base3cBillItemQuery;
import com.ndlan.ieream.model.Base3cBillItemBean;

public class Base3cBillItemBeanBustinessRestfulTest {
	
	Base3cBillItemBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cBillItemBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cBillItemBean entity=new Base3cBillItemBean();
		//todo
	...
	public void selectList() {
		Base3cBillItemQuery entity=new Base3cBillItemQuery();
		//todo
