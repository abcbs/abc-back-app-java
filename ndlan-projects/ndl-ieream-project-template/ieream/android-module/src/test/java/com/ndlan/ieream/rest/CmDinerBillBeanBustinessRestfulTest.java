...
import com.ndlan.ieream.query.CmDinerBillQuery;
import com.ndlan.ieream.model.CmDinerBillBean;

public class CmDinerBillBeanBustinessRestfulTest {
	
	CmDinerBillBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDinerBillBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDinerBillBean entity=new CmDinerBillBean();
		//todo
	...
	public void selectList() {
		CmDinerBillQuery entity=new CmDinerBillQuery();
		//todo
