...
import com.ndlan.ieream.query.CmRestNewsQuery;
import com.ndlan.ieream.model.CmRestNewsBean;

public class CmRestNewsBeanBustinessRestfulTest {
	
	CmRestNewsBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRestNewsBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRestNewsBean entity=new CmRestNewsBean();
		//todo
	...
	public void selectList() {
		CmRestNewsQuery entity=new CmRestNewsQuery();
		//todo
