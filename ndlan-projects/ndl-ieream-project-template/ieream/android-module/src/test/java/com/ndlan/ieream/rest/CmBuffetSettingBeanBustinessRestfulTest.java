...
import com.ndlan.ieream.query.CmBuffetSettingQuery;
import com.ndlan.ieream.model.CmBuffetSettingBean;

public class CmBuffetSettingBeanBustinessRestfulTest {
	
	CmBuffetSettingBeanBustinessRestful productCatatoryBustinessRestful=
			new CmBuffetSettingBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmBuffetSettingBean entity=new CmBuffetSettingBean();
		//todo
	...
	public void selectList() {
		CmBuffetSettingQuery entity=new CmBuffetSettingQuery();
		//todo
