...
import com.ndlan.ieream.query.CmSpecialDishesQuery;
import com.ndlan.ieream.model.CmSpecialDishesBean;

public class CmSpecialDishesBeanBustinessRestfulTest {
	
	CmSpecialDishesBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSpecialDishesBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSpecialDishesBean entity=new CmSpecialDishesBean();
		//todo
	...
	public void selectList() {
		CmSpecialDishesQuery entity=new CmSpecialDishesQuery();
		//todo
