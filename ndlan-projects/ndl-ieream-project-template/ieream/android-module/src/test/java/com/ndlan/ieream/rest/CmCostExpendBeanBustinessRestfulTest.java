...
import com.ndlan.ieream.query.CmCostExpendQuery;
import com.ndlan.ieream.model.CmCostExpendBean;

public class CmCostExpendBeanBustinessRestfulTest {
	
	CmCostExpendBeanBustinessRestful productCatatoryBustinessRestful=
			new CmCostExpendBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmCostExpendBean entity=new CmCostExpendBean();
		//todo
	...
	public void selectList() {
		CmCostExpendQuery entity=new CmCostExpendQuery();
		//todo
