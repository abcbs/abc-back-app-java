...
import com.ndlan.ieream.query.CmEmployeShiftIncomeQuery;
import com.ndlan.ieream.model.CmEmployeShiftIncomeBean;

public class CmEmployeShiftIncomeBeanBustinessRestfulTest {
	
	CmEmployeShiftIncomeBeanBustinessRestful productCatatoryBustinessRestful=
			new CmEmployeShiftIncomeBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmEmployeShiftIncomeBean entity=new CmEmployeShiftIncomeBean();
		//todo
	...
	public void selectList() {
		CmEmployeShiftIncomeQuery entity=new CmEmployeShiftIncomeQuery();
		//todo
