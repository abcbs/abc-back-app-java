...
import com.ndlan.ieream.query.CmMemberInfoQuery;
import com.ndlan.ieream.model.CmMemberInfoBean;

public class CmMemberInfoBeanBustinessRestfulTest {
	
	CmMemberInfoBeanBustinessRestful productCatatoryBustinessRestful=
			new CmMemberInfoBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmMemberInfoBean entity=new CmMemberInfoBean();
		//todo
	...
	public void selectList() {
		CmMemberInfoQuery entity=new CmMemberInfoQuery();
		//todo
