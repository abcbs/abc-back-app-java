...
import com.ndlan.ieream.query.CmDishesPicQuery;
import com.ndlan.ieream.model.CmDishesPicBean;

public class CmDishesPicBeanBustinessRestfulTest {
	
	CmDishesPicBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesPicBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesPicBean entity=new CmDishesPicBean();
		//todo
	...
	public void selectList() {
		CmDishesPicQuery entity=new CmDishesPicQuery();
		//todo
