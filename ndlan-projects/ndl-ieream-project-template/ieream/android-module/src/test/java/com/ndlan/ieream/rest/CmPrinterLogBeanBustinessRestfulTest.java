...
import com.ndlan.ieream.query.CmPrinterLogQuery;
import com.ndlan.ieream.model.CmPrinterLogBean;

public class CmPrinterLogBeanBustinessRestfulTest {
	
	CmPrinterLogBeanBustinessRestful productCatatoryBustinessRestful=
			new CmPrinterLogBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmPrinterLogBean entity=new CmPrinterLogBean();
		//todo
	...
	public void selectList() {
		CmPrinterLogQuery entity=new CmPrinterLogQuery();
		//todo
