...
import com.ndlan.ieream.query.CmJourQuery;
import com.ndlan.ieream.model.CmJourBean;

public class CmJourBeanBustinessRestfulTest {
	
	CmJourBeanBustinessRestful productCatatoryBustinessRestful=
			new CmJourBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmJourBean entity=new CmJourBean();
		//todo
	...
	public void selectList() {
		CmJourQuery entity=new CmJourQuery();
		//todo
