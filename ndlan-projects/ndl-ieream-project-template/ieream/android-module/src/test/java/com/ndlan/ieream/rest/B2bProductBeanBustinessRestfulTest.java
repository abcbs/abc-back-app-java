...
import com.ndlan.ieream.query.B2bProductQuery;
import com.ndlan.ieream.model.B2bProductBean;

public class B2bProductBeanBustinessRestfulTest {
	
	B2bProductBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bProductBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bProductBean entity=new B2bProductBean();
		//todo
	...
	public void selectList() {
		B2bProductQuery entity=new B2bProductQuery();
		//todo
