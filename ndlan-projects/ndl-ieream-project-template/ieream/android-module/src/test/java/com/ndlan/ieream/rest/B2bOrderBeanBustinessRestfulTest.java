...
import com.ndlan.ieream.query.B2bOrderQuery;
import com.ndlan.ieream.model.B2bOrderBean;

public class B2bOrderBeanBustinessRestfulTest {
	
	B2bOrderBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bOrderBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bOrderBean entity=new B2bOrderBean();
		//todo
	...
	public void selectList() {
		B2bOrderQuery entity=new B2bOrderQuery();
		//todo
