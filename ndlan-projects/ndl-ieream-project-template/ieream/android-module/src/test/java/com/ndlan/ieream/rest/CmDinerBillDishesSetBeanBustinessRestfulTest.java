...
import com.ndlan.ieream.query.CmDinerBillDishesSetQuery;
import com.ndlan.ieream.model.CmDinerBillDishesSetBean;

public class CmDinerBillDishesSetBeanBustinessRestfulTest {
	
	CmDinerBillDishesSetBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDinerBillDishesSetBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDinerBillDishesSetBean entity=new CmDinerBillDishesSetBean();
		//todo
	...
	public void selectList() {
		CmDinerBillDishesSetQuery entity=new CmDinerBillDishesSetQuery();
		//todo
