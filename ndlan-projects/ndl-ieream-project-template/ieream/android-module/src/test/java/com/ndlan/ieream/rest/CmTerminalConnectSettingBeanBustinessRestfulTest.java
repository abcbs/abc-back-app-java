...
import com.ndlan.ieream.query.CmTerminalConnectSettingQuery;
import com.ndlan.ieream.model.CmTerminalConnectSettingBean;

public class CmTerminalConnectSettingBeanBustinessRestfulTest {
	
	CmTerminalConnectSettingBeanBustinessRestful productCatatoryBustinessRestful=
			new CmTerminalConnectSettingBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmTerminalConnectSettingBean entity=new CmTerminalConnectSettingBean();
		//todo
	...
	public void selectList() {
		CmTerminalConnectSettingQuery entity=new CmTerminalConnectSettingQuery();
		//todo
