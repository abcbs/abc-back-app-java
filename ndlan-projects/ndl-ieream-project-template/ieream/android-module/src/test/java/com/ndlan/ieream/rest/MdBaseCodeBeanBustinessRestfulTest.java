...
import com.ndlan.ieream.query.MdBaseCodeQuery;
import com.ndlan.ieream.model.MdBaseCodeBean;

public class MdBaseCodeBeanBustinessRestfulTest {
	
	MdBaseCodeBeanBustinessRestful productCatatoryBustinessRestful=
			new MdBaseCodeBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		MdBaseCodeBean entity=new MdBaseCodeBean();
		//todo
	...
	public void selectList() {
		MdBaseCodeQuery entity=new MdBaseCodeQuery();
		//todo
