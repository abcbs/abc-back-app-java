...
import com.ndlan.ieream.query.CmSysLogQuery;
import com.ndlan.ieream.model.CmSysLogBean;

public class CmSysLogBeanBustinessRestfulTest {
	
	CmSysLogBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSysLogBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSysLogBean entity=new CmSysLogBean();
		//todo
	...
	public void selectList() {
		CmSysLogQuery entity=new CmSysLogQuery();
		//todo
