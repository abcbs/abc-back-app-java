...
import com.ndlan.ieream.query.CmMembershipCardQuery;
import com.ndlan.ieream.model.CmMembershipCardBean;

public class CmMembershipCardBeanBustinessRestfulTest {
	
	CmMembershipCardBeanBustinessRestful productCatatoryBustinessRestful=
			new CmMembershipCardBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmMembershipCardBean entity=new CmMembershipCardBean();
		//todo
	...
	public void selectList() {
		CmMembershipCardQuery entity=new CmMembershipCardQuery();
		//todo
