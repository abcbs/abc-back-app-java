...
import com.ndlan.ieream.query.CmCashDiscountQuery;
import com.ndlan.ieream.model.CmCashDiscountBean;

public class CmCashDiscountBeanBustinessRestfulTest {
	
	CmCashDiscountBeanBustinessRestful productCatatoryBustinessRestful=
			new CmCashDiscountBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmCashDiscountBean entity=new CmCashDiscountBean();
		//todo
	...
	public void selectList() {
		CmCashDiscountQuery entity=new CmCashDiscountQuery();
		//todo
