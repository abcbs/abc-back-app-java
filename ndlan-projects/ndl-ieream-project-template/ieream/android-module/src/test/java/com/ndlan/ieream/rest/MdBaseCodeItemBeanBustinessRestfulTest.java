...
import com.ndlan.ieream.query.MdBaseCodeItemQuery;
import com.ndlan.ieream.model.MdBaseCodeItemBean;

public class MdBaseCodeItemBeanBustinessRestfulTest {
	
	MdBaseCodeItemBeanBustinessRestful productCatatoryBustinessRestful=
			new MdBaseCodeItemBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		MdBaseCodeItemBean entity=new MdBaseCodeItemBean();
		//todo
	...
	public void selectList() {
		MdBaseCodeItemQuery entity=new MdBaseCodeItemQuery();
		//todo
