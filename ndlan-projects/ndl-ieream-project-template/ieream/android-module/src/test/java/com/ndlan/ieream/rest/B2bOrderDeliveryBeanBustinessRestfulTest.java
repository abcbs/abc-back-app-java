...
import com.ndlan.ieream.query.B2bOrderDeliveryQuery;
import com.ndlan.ieream.model.B2bOrderDeliveryBean;

public class B2bOrderDeliveryBeanBustinessRestfulTest {
	
	B2bOrderDeliveryBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bOrderDeliveryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bOrderDeliveryBean entity=new B2bOrderDeliveryBean();
		//todo
	...
	public void selectList() {
		B2bOrderDeliveryQuery entity=new B2bOrderDeliveryQuery();
		//todo
