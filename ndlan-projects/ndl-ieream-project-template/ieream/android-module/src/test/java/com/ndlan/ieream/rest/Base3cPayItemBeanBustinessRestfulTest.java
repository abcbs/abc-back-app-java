...
import com.ndlan.ieream.query.Base3cPayItemQuery;
import com.ndlan.ieream.model.Base3cPayItemBean;

public class Base3cPayItemBeanBustinessRestfulTest {
	
	Base3cPayItemBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cPayItemBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cPayItemBean entity=new Base3cPayItemBean();
		//todo
	...
	public void selectList() {
		Base3cPayItemQuery entity=new Base3cPayItemQuery();
		//todo
