...
import com.ndlan.ieream.query.B2bProCategoryQuery;
import com.ndlan.ieream.model.B2bProCategoryBean;

public class B2bProCategoryBeanBustinessRestfulTest {
	
	B2bProCategoryBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bProCategoryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bProCategoryBean entity=new B2bProCategoryBean();
		//todo
	...
	public void selectList() {
		B2bProCategoryQuery entity=new B2bProCategoryQuery();
		//todo
