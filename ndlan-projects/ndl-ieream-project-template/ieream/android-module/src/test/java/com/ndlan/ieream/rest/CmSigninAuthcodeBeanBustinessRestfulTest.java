...
import com.ndlan.ieream.query.CmSigninAuthcodeQuery;
import com.ndlan.ieream.model.CmSigninAuthcodeBean;

public class CmSigninAuthcodeBeanBustinessRestfulTest {
	
	CmSigninAuthcodeBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSigninAuthcodeBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSigninAuthcodeBean entity=new CmSigninAuthcodeBean();
		//todo
	...
	public void selectList() {
		CmSigninAuthcodeQuery entity=new CmSigninAuthcodeQuery();
		//todo
