...
import com.ndlan.ieream.query.CmAlipayQuery;
import com.ndlan.ieream.model.CmAlipayBean;

public class CmAlipayBeanBustinessRestfulTest {
	
	CmAlipayBeanBustinessRestful productCatatoryBustinessRestful=
			new CmAlipayBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmAlipayBean entity=new CmAlipayBean();
		//todo
	...
	public void selectList() {
		CmAlipayQuery entity=new CmAlipayQuery();
		//todo
