...
import com.ndlan.ieream.query.CmRestMemberInfoQuery;
import com.ndlan.ieream.model.CmRestMemberInfoBean;

public class CmRestMemberInfoBeanBustinessRestfulTest {
	
	CmRestMemberInfoBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRestMemberInfoBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRestMemberInfoBean entity=new CmRestMemberInfoBean();
		//todo
	...
	public void selectList() {
		CmRestMemberInfoQuery entity=new CmRestMemberInfoQuery();
		//todo
