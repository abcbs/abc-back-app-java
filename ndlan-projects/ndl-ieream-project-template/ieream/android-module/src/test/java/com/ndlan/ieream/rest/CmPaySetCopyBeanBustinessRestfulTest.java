...
import com.ndlan.ieream.query.CmPaySetCopyQuery;
import com.ndlan.ieream.model.CmPaySetCopyBean;

public class CmPaySetCopyBeanBustinessRestfulTest {
	
	CmPaySetCopyBeanBustinessRestful productCatatoryBustinessRestful=
			new CmPaySetCopyBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmPaySetCopyBean entity=new CmPaySetCopyBean();
		//todo
	...
	public void selectList() {
		CmPaySetCopyQuery entity=new CmPaySetCopyQuery();
		//todo
