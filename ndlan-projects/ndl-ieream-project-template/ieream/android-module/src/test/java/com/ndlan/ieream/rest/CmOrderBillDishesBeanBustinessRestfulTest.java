...
import com.ndlan.ieream.query.CmOrderBillDishesQuery;
import com.ndlan.ieream.model.CmOrderBillDishesBean;

public class CmOrderBillDishesBeanBustinessRestfulTest {
	
	CmOrderBillDishesBeanBustinessRestful productCatatoryBustinessRestful=
			new CmOrderBillDishesBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmOrderBillDishesBean entity=new CmOrderBillDishesBean();
		//todo
	...
	public void selectList() {
		CmOrderBillDishesQuery entity=new CmOrderBillDishesQuery();
		//todo
