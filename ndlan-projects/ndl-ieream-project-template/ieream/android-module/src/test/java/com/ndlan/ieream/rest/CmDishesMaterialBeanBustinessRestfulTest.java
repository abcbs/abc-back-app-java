...
import com.ndlan.ieream.query.CmDishesMaterialQuery;
import com.ndlan.ieream.model.CmDishesMaterialBean;

public class CmDishesMaterialBeanBustinessRestfulTest {
	
	CmDishesMaterialBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesMaterialBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesMaterialBean entity=new CmDishesMaterialBean();
		//todo
	...
	public void selectList() {
		CmDishesMaterialQuery entity=new CmDishesMaterialQuery();
		//todo
