...
import com.ndlan.ieream.query.SysDictionaryQuery;
import com.ndlan.ieream.model.SysDictionaryBean;

public class SysDictionaryBeanBustinessRestfulTest {
	
	SysDictionaryBeanBustinessRestful productCatatoryBustinessRestful=
			new SysDictionaryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		SysDictionaryBean entity=new SysDictionaryBean();
		//todo
	...
	public void selectList() {
		SysDictionaryQuery entity=new SysDictionaryQuery();
		//todo
