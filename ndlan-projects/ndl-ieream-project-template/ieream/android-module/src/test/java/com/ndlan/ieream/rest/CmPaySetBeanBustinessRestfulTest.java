...
import com.ndlan.ieream.query.CmPaySetQuery;
import com.ndlan.ieream.model.CmPaySetBean;

public class CmPaySetBeanBustinessRestfulTest {
	
	CmPaySetBeanBustinessRestful productCatatoryBustinessRestful=
			new CmPaySetBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmPaySetBean entity=new CmPaySetBean();
		//todo
	...
	public void selectList() {
		CmPaySetQuery entity=new CmPaySetQuery();
		//todo
