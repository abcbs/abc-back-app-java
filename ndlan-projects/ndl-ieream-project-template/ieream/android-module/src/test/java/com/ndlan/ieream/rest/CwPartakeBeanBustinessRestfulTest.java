...
import com.ndlan.ieream.query.CwPartakeQuery;
import com.ndlan.ieream.model.CwPartakeBean;

public class CwPartakeBeanBustinessRestfulTest {
	
	CwPartakeBeanBustinessRestful productCatatoryBustinessRestful=
			new CwPartakeBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwPartakeBean entity=new CwPartakeBean();
		//todo
	...
	public void selectList() {
		CwPartakeQuery entity=new CwPartakeQuery();
		//todo
