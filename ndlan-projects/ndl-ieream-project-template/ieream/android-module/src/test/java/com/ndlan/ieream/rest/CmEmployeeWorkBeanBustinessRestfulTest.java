...
import com.ndlan.ieream.query.CmEmployeeWorkQuery;
import com.ndlan.ieream.model.CmEmployeeWorkBean;

public class CmEmployeeWorkBeanBustinessRestfulTest {
	
	CmEmployeeWorkBeanBustinessRestful productCatatoryBustinessRestful=
			new CmEmployeeWorkBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmEmployeeWorkBean entity=new CmEmployeeWorkBean();
		//todo
	...
	public void selectList() {
		CmEmployeeWorkQuery entity=new CmEmployeeWorkQuery();
		//todo
