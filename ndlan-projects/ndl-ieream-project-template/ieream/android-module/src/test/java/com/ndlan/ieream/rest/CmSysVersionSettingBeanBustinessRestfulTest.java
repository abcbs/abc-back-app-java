...
import com.ndlan.ieream.query.CmSysVersionSettingQuery;
import com.ndlan.ieream.model.CmSysVersionSettingBean;

public class CmSysVersionSettingBeanBustinessRestfulTest {
	
	CmSysVersionSettingBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSysVersionSettingBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSysVersionSettingBean entity=new CmSysVersionSettingBean();
		//todo
	...
	public void selectList() {
		CmSysVersionSettingQuery entity=new CmSysVersionSettingQuery();
		//todo
