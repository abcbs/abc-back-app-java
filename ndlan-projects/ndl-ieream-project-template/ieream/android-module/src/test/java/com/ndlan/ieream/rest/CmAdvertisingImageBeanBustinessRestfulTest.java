...
import com.ndlan.ieream.query.CmAdvertisingImageQuery;
import com.ndlan.ieream.model.CmAdvertisingImageBean;

public class CmAdvertisingImageBeanBustinessRestfulTest {
	
	CmAdvertisingImageBeanBustinessRestful productCatatoryBustinessRestful=
			new CmAdvertisingImageBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmAdvertisingImageBean entity=new CmAdvertisingImageBean();
		//todo
	...
	public void selectList() {
		CmAdvertisingImageQuery entity=new CmAdvertisingImageQuery();
		//todo
