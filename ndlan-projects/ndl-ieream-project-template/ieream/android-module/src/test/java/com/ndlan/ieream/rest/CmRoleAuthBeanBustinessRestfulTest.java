...
import com.ndlan.ieream.query.CmRoleAuthQuery;
import com.ndlan.ieream.model.CmRoleAuthBean;

public class CmRoleAuthBeanBustinessRestfulTest {
	
	CmRoleAuthBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRoleAuthBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRoleAuthBean entity=new CmRoleAuthBean();
		//todo
	...
	public void selectList() {
		CmRoleAuthQuery entity=new CmRoleAuthQuery();
		//todo
