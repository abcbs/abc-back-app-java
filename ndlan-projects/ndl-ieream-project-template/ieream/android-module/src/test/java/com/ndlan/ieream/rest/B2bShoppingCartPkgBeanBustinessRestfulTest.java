...
import com.ndlan.ieream.query.B2bShoppingCartPkgQuery;
import com.ndlan.ieream.model.B2bShoppingCartPkgBean;

public class B2bShoppingCartPkgBeanBustinessRestfulTest {
	
	B2bShoppingCartPkgBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bShoppingCartPkgBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bShoppingCartPkgBean entity=new B2bShoppingCartPkgBean();
		//todo
	...
	public void selectList() {
		B2bShoppingCartPkgQuery entity=new B2bShoppingCartPkgQuery();
		//todo
