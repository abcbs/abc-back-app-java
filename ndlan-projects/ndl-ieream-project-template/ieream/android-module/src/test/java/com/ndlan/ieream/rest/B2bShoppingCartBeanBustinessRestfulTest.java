...
import com.ndlan.ieream.query.B2bShoppingCartQuery;
import com.ndlan.ieream.model.B2bShoppingCartBean;

public class B2bShoppingCartBeanBustinessRestfulTest {
	
	B2bShoppingCartBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bShoppingCartBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bShoppingCartBean entity=new B2bShoppingCartBean();
		//todo
	...
	public void selectList() {
		B2bShoppingCartQuery entity=new B2bShoppingCartQuery();
		//todo
