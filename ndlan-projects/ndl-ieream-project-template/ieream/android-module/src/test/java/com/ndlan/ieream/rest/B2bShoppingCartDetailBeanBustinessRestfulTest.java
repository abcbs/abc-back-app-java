...
import com.ndlan.ieream.query.B2bShoppingCartDetailQuery;
import com.ndlan.ieream.model.B2bShoppingCartDetailBean;

public class B2bShoppingCartDetailBeanBustinessRestfulTest {
	
	B2bShoppingCartDetailBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bShoppingCartDetailBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bShoppingCartDetailBean entity=new B2bShoppingCartDetailBean();
		//todo
	...
	public void selectList() {
		B2bShoppingCartDetailQuery entity=new B2bShoppingCartDetailQuery();
		//todo
