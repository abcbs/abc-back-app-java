...
import com.ndlan.ieream.query.B2bOrderItemQuery;
import com.ndlan.ieream.model.B2bOrderItemBean;

public class B2bOrderItemBeanBustinessRestfulTest {
	
	B2bOrderItemBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bOrderItemBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bOrderItemBean entity=new B2bOrderItemBean();
		//todo
	...
	public void selectList() {
		B2bOrderItemQuery entity=new B2bOrderItemQuery();
		//todo
