...
import com.ndlan.ieream.query.CmComplaintSuggestQuery;
import com.ndlan.ieream.model.CmComplaintSuggestBean;

public class CmComplaintSuggestBeanBustinessRestfulTest {
	
	CmComplaintSuggestBeanBustinessRestful productCatatoryBustinessRestful=
			new CmComplaintSuggestBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmComplaintSuggestBean entity=new CmComplaintSuggestBean();
		//todo
	...
	public void selectList() {
		CmComplaintSuggestQuery entity=new CmComplaintSuggestQuery();
		//todo
