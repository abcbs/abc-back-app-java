...
import com.ndlan.ieream.query.CmTableBillRelationQuery;
import com.ndlan.ieream.model.CmTableBillRelationBean;

public class CmTableBillRelationBeanBustinessRestfulTest {
	
	CmTableBillRelationBeanBustinessRestful productCatatoryBustinessRestful=
			new CmTableBillRelationBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmTableBillRelationBean entity=new CmTableBillRelationBean();
		//todo
	...
	public void selectList() {
		CmTableBillRelationQuery entity=new CmTableBillRelationQuery();
		//todo
