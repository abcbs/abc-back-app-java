...
import com.ndlan.ieream.query.CmDateQuery;
import com.ndlan.ieream.model.CmDateBean;

public class CmDateBeanBustinessRestfulTest {
	
	CmDateBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDateBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDateBean entity=new CmDateBean();
		//todo
	...
	public void selectList() {
		CmDateQuery entity=new CmDateQuery();
		//todo
