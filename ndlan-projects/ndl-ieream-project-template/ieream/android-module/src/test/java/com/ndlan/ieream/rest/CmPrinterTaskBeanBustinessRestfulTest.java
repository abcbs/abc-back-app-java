...
import com.ndlan.ieream.query.CmPrinterTaskQuery;
import com.ndlan.ieream.model.CmPrinterTaskBean;

public class CmPrinterTaskBeanBustinessRestfulTest {
	
	CmPrinterTaskBeanBustinessRestful productCatatoryBustinessRestful=
			new CmPrinterTaskBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmPrinterTaskBean entity=new CmPrinterTaskBean();
		//todo
	...
	public void selectList() {
		CmPrinterTaskQuery entity=new CmPrinterTaskQuery();
		//todo
