...
import com.ndlan.ieream.query.CmBackupSettingQuery;
import com.ndlan.ieream.model.CmBackupSettingBean;

public class CmBackupSettingBeanBustinessRestfulTest {
	
	CmBackupSettingBeanBustinessRestful productCatatoryBustinessRestful=
			new CmBackupSettingBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmBackupSettingBean entity=new CmBackupSettingBean();
		//todo
	...
	public void selectList() {
		CmBackupSettingQuery entity=new CmBackupSettingQuery();
		//todo
