...
import com.ndlan.ieream.query.Base3cShoppingCartItemQuery;
import com.ndlan.ieream.model.Base3cShoppingCartItemBean;

public class Base3cShoppingCartItemBeanBustinessRestfulTest {
	
	Base3cShoppingCartItemBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cShoppingCartItemBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cShoppingCartItemBean entity=new Base3cShoppingCartItemBean();
		//todo
	...
	public void selectList() {
		Base3cShoppingCartItemQuery entity=new Base3cShoppingCartItemQuery();
		//todo
