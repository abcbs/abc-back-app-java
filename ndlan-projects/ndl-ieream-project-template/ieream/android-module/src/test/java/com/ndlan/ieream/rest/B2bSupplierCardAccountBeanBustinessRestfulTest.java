...
import com.ndlan.ieream.query.B2bSupplierCardAccountQuery;
import com.ndlan.ieream.model.B2bSupplierCardAccountBean;

public class B2bSupplierCardAccountBeanBustinessRestfulTest {
	
	B2bSupplierCardAccountBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bSupplierCardAccountBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bSupplierCardAccountBean entity=new B2bSupplierCardAccountBean();
		//todo
	...
	public void selectList() {
		B2bSupplierCardAccountQuery entity=new B2bSupplierCardAccountQuery();
		//todo
