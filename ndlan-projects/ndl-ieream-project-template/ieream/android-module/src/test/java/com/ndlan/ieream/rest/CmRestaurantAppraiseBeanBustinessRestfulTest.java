...
import com.ndlan.ieream.query.CmRestaurantAppraiseQuery;
import com.ndlan.ieream.model.CmRestaurantAppraiseBean;

public class CmRestaurantAppraiseBeanBustinessRestfulTest {
	
	CmRestaurantAppraiseBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRestaurantAppraiseBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRestaurantAppraiseBean entity=new CmRestaurantAppraiseBean();
		//todo
	...
	public void selectList() {
		CmRestaurantAppraiseQuery entity=new CmRestaurantAppraiseQuery();
		//todo
