...
import com.ndlan.ieream.query.CmPrinterQuery;
import com.ndlan.ieream.model.CmPrinterBean;

public class CmPrinterBeanBustinessRestfulTest {
	
	CmPrinterBeanBustinessRestful productCatatoryBustinessRestful=
			new CmPrinterBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmPrinterBean entity=new CmPrinterBean();
		//todo
	...
	public void selectList() {
		CmPrinterQuery entity=new CmPrinterQuery();
		//todo
