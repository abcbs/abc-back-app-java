...
import com.ndlan.ieream.query.Base3cBillQuery;
import com.ndlan.ieream.model.Base3cBillBean;

public class Base3cBillBeanBustinessRestfulTest {
	
	Base3cBillBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cBillBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cBillBean entity=new Base3cBillBean();
		//todo
	...
	public void selectList() {
		Base3cBillQuery entity=new Base3cBillQuery();
		//todo
