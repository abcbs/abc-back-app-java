...
import com.ndlan.ieream.query.CmDishesSetQuery;
import com.ndlan.ieream.model.CmDishesSetBean;

public class CmDishesSetBeanBustinessRestfulTest {
	
	CmDishesSetBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesSetBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesSetBean entity=new CmDishesSetBean();
		//todo
	...
	public void selectList() {
		CmDishesSetQuery entity=new CmDishesSetQuery();
		//todo
