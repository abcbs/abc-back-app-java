...
import com.ndlan.ieream.query.Base3cReturnReasonQuery;
import com.ndlan.ieream.model.Base3cReturnReasonBean;

public class Base3cReturnReasonBeanBustinessRestfulTest {
	
	Base3cReturnReasonBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cReturnReasonBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cReturnReasonBean entity=new Base3cReturnReasonBean();
		//todo
	...
	public void selectList() {
		Base3cReturnReasonQuery entity=new Base3cReturnReasonQuery();
		//todo
