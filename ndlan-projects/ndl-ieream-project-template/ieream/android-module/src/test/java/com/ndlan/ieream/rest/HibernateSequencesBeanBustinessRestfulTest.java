...
import com.ndlan.ieream.query.HibernateSequencesQuery;
import com.ndlan.ieream.model.HibernateSequencesBean;

public class HibernateSequencesBeanBustinessRestfulTest {
	
	HibernateSequencesBeanBustinessRestful productCatatoryBustinessRestful=
			new HibernateSequencesBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		HibernateSequencesBean entity=new HibernateSequencesBean();
		//todo
	...
	public void selectList() {
		HibernateSequencesQuery entity=new HibernateSequencesQuery();
		//todo
