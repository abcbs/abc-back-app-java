...
import com.ndlan.ieream.query.CmRestaurantPicQuery;
import com.ndlan.ieream.model.CmRestaurantPicBean;

public class CmRestaurantPicBeanBustinessRestfulTest {
	
	CmRestaurantPicBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRestaurantPicBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRestaurantPicBean entity=new CmRestaurantPicBean();
		//todo
	...
	public void selectList() {
		CmRestaurantPicQuery entity=new CmRestaurantPicQuery();
		//todo
