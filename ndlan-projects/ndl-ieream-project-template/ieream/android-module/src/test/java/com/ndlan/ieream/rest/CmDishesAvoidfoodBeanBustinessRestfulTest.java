...
import com.ndlan.ieream.query.CmDishesAvoidfoodQuery;
import com.ndlan.ieream.model.CmDishesAvoidfoodBean;

public class CmDishesAvoidfoodBeanBustinessRestfulTest {
	
	CmDishesAvoidfoodBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesAvoidfoodBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesAvoidfoodBean entity=new CmDishesAvoidfoodBean();
		//todo
	...
	public void selectList() {
		CmDishesAvoidfoodQuery entity=new CmDishesAvoidfoodQuery();
		//todo
