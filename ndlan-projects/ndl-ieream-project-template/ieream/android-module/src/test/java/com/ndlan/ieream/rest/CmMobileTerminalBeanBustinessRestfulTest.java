...
import com.ndlan.ieream.query.CmMobileTerminalQuery;
import com.ndlan.ieream.model.CmMobileTerminalBean;

public class CmMobileTerminalBeanBustinessRestfulTest {
	
	CmMobileTerminalBeanBustinessRestful productCatatoryBustinessRestful=
			new CmMobileTerminalBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmMobileTerminalBean entity=new CmMobileTerminalBean();
		//todo
	...
	public void selectList() {
		CmMobileTerminalQuery entity=new CmMobileTerminalQuery();
		//todo
