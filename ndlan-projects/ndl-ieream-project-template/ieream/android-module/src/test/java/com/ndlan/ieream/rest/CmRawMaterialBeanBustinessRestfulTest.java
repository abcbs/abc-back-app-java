...
import com.ndlan.ieream.query.CmRawMaterialQuery;
import com.ndlan.ieream.model.CmRawMaterialBean;

public class CmRawMaterialBeanBustinessRestfulTest {
	
	CmRawMaterialBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRawMaterialBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRawMaterialBean entity=new CmRawMaterialBean();
		//todo
	...
	public void selectList() {
		CmRawMaterialQuery entity=new CmRawMaterialQuery();
		//todo
