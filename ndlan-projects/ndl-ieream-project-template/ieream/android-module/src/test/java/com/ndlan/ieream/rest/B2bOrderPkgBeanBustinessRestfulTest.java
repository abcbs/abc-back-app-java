...
import com.ndlan.ieream.query.B2bOrderPkgQuery;
import com.ndlan.ieream.model.B2bOrderPkgBean;

public class B2bOrderPkgBeanBustinessRestfulTest {
	
	B2bOrderPkgBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bOrderPkgBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bOrderPkgBean entity=new B2bOrderPkgBean();
		//todo
	...
	public void selectList() {
		B2bOrderPkgQuery entity=new B2bOrderPkgQuery();
		//todo
