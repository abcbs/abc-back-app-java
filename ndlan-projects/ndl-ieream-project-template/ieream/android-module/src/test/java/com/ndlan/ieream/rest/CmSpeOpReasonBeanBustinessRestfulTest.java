...
import com.ndlan.ieream.query.CmSpeOpReasonQuery;
import com.ndlan.ieream.model.CmSpeOpReasonBean;

public class CmSpeOpReasonBeanBustinessRestfulTest {
	
	CmSpeOpReasonBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSpeOpReasonBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSpeOpReasonBean entity=new CmSpeOpReasonBean();
		//todo
	...
	public void selectList() {
		CmSpeOpReasonQuery entity=new CmSpeOpReasonQuery();
		//todo
