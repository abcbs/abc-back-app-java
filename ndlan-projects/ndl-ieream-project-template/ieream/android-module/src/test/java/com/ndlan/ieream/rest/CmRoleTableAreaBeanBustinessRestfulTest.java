...
import com.ndlan.ieream.query.CmRoleTableAreaQuery;
import com.ndlan.ieream.model.CmRoleTableAreaBean;

public class CmRoleTableAreaBeanBustinessRestfulTest {
	
	CmRoleTableAreaBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRoleTableAreaBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRoleTableAreaBean entity=new CmRoleTableAreaBean();
		//todo
	...
	public void selectList() {
		CmRoleTableAreaQuery entity=new CmRoleTableAreaQuery();
		//todo
