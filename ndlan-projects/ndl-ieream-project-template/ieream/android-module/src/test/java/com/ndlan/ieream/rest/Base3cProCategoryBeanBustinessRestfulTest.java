...
import com.ndlan.ieream.query.Base3cProCategoryQuery;
import com.ndlan.ieream.model.Base3cProCategoryBean;

public class Base3cProCategoryBeanBustinessRestfulTest {
	
	Base3cProCategoryBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cProCategoryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cProCategoryBean entity=new Base3cProCategoryBean();
		//todo
	...
	public void selectList() {
		Base3cProCategoryQuery entity=new Base3cProCategoryQuery();
		//todo
