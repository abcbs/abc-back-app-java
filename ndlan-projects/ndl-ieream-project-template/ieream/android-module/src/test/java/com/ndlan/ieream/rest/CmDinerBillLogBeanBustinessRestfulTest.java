...
import com.ndlan.ieream.query.CmDinerBillLogQuery;
import com.ndlan.ieream.model.CmDinerBillLogBean;

public class CmDinerBillLogBeanBustinessRestfulTest {
	
	CmDinerBillLogBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDinerBillLogBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDinerBillLogBean entity=new CmDinerBillLogBean();
		//todo
	...
	public void selectList() {
		CmDinerBillLogQuery entity=new CmDinerBillLogQuery();
		//todo
