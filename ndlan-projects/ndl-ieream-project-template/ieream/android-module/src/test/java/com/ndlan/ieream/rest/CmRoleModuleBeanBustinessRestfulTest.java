...
import com.ndlan.ieream.query.CmRoleModuleQuery;
import com.ndlan.ieream.model.CmRoleModuleBean;

public class CmRoleModuleBeanBustinessRestfulTest {
	
	CmRoleModuleBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRoleModuleBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRoleModuleBean entity=new CmRoleModuleBean();
		//todo
	...
	public void selectList() {
		CmRoleModuleQuery entity=new CmRoleModuleQuery();
		//todo
