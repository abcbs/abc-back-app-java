...
import com.ndlan.ieream.query.CmRestaurantQuery;
import com.ndlan.ieream.model.CmRestaurantBean;

public class CmRestaurantBeanBustinessRestfulTest {
	
	CmRestaurantBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRestaurantBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRestaurantBean entity=new CmRestaurantBean();
		//todo
	...
	public void selectList() {
		CmRestaurantQuery entity=new CmRestaurantQuery();
		//todo
