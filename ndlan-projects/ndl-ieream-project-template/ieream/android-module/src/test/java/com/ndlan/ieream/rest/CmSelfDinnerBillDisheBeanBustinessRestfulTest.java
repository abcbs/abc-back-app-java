...
import com.ndlan.ieream.query.CmSelfDinnerBillDisheQuery;
import com.ndlan.ieream.model.CmSelfDinnerBillDisheBean;

public class CmSelfDinnerBillDisheBeanBustinessRestfulTest {
	
	CmSelfDinnerBillDisheBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSelfDinnerBillDisheBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSelfDinnerBillDisheBean entity=new CmSelfDinnerBillDisheBean();
		//todo
	...
	public void selectList() {
		CmSelfDinnerBillDisheQuery entity=new CmSelfDinnerBillDisheQuery();
		//todo
