...
import com.ndlan.ieream.query.CmDinerBillPaymentQuery;
import com.ndlan.ieream.model.CmDinerBillPaymentBean;

public class CmDinerBillPaymentBeanBustinessRestfulTest {
	
	CmDinerBillPaymentBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDinerBillPaymentBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDinerBillPaymentBean entity=new CmDinerBillPaymentBean();
		//todo
	...
	public void selectList() {
		CmDinerBillPaymentQuery entity=new CmDinerBillPaymentQuery();
		//todo
