...
import com.ndlan.ieream.query.CmSendsmsQuery;
import com.ndlan.ieream.model.CmSendsmsBean;

public class CmSendsmsBeanBustinessRestfulTest {
	
	CmSendsmsBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSendsmsBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSendsmsBean entity=new CmSendsmsBean();
		//todo
	...
	public void selectList() {
		CmSendsmsQuery entity=new CmSendsmsQuery();
		//todo
