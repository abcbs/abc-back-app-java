...
import com.ndlan.ieream.query.B2bLogisticsRealtimeQuery;
import com.ndlan.ieream.model.B2bLogisticsRealtimeBean;

public class B2bLogisticsRealtimeBeanBustinessRestfulTest {
	
	B2bLogisticsRealtimeBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bLogisticsRealtimeBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bLogisticsRealtimeBean entity=new B2bLogisticsRealtimeBean();
		//todo
	...
	public void selectList() {
		B2bLogisticsRealtimeQuery entity=new B2bLogisticsRealtimeQuery();
		//todo
