...
import com.ndlan.ieream.query.CmMessageQuery;
import com.ndlan.ieream.model.CmMessageBean;

public class CmMessageBeanBustinessRestfulTest {
	
	CmMessageBeanBustinessRestful productCatatoryBustinessRestful=
			new CmMessageBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmMessageBean entity=new CmMessageBean();
		//todo
	...
	public void selectList() {
		CmMessageQuery entity=new CmMessageQuery();
		//todo
