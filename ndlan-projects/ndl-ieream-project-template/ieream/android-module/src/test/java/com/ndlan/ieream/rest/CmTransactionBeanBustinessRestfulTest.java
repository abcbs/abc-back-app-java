...
import com.ndlan.ieream.query.CmTransactionQuery;
import com.ndlan.ieream.model.CmTransactionBean;

public class CmTransactionBeanBustinessRestfulTest {
	
	CmTransactionBeanBustinessRestful productCatatoryBustinessRestful=
			new CmTransactionBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmTransactionBean entity=new CmTransactionBean();
		//todo
	...
	public void selectList() {
		CmTransactionQuery entity=new CmTransactionQuery();
		//todo
