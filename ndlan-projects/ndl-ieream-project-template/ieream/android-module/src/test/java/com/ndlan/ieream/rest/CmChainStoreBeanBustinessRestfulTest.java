...
import com.ndlan.ieream.query.CmChainStoreQuery;
import com.ndlan.ieream.model.CmChainStoreBean;

public class CmChainStoreBeanBustinessRestfulTest {
	
	CmChainStoreBeanBustinessRestful productCatatoryBustinessRestful=
			new CmChainStoreBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmChainStoreBean entity=new CmChainStoreBean();
		//todo
	...
	public void selectList() {
		CmChainStoreQuery entity=new CmChainStoreQuery();
		//todo
