...
import com.ndlan.ieream.query.Base3cProductQuery;
import com.ndlan.ieream.model.Base3cProductBean;

public class Base3cProductBeanBustinessRestfulTest {
	
	Base3cProductBeanBustinessRestful productCatatoryBustinessRestful=
			new Base3cProductBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		Base3cProductBean entity=new Base3cProductBean();
		//todo
	...
	public void selectList() {
		Base3cProductQuery entity=new Base3cProductQuery();
		//todo
