...
import com.ndlan.ieream.query.CmWorkstationQuery;
import com.ndlan.ieream.model.CmWorkstationBean;

public class CmWorkstationBeanBustinessRestfulTest {
	
	CmWorkstationBeanBustinessRestful productCatatoryBustinessRestful=
			new CmWorkstationBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmWorkstationBean entity=new CmWorkstationBean();
		//todo
	...
	public void selectList() {
		CmWorkstationQuery entity=new CmWorkstationQuery();
		//todo
