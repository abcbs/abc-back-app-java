...
import com.ndlan.ieream.query.CmBusiLogQuery;
import com.ndlan.ieream.model.CmBusiLogBean;

public class CmBusiLogBeanBustinessRestfulTest {
	
	CmBusiLogBeanBustinessRestful productCatatoryBustinessRestful=
			new CmBusiLogBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmBusiLogBean entity=new CmBusiLogBean();
		//todo
	...
	public void selectList() {
		CmBusiLogQuery entity=new CmBusiLogQuery();
		//todo
