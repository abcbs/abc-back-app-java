...
import com.ndlan.ieream.query.CmResettleLogQuery;
import com.ndlan.ieream.model.CmResettleLogBean;

public class CmResettleLogBeanBustinessRestfulTest {
	
	CmResettleLogBeanBustinessRestful productCatatoryBustinessRestful=
			new CmResettleLogBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmResettleLogBean entity=new CmResettleLogBean();
		//todo
	...
	public void selectList() {
		CmResettleLogQuery entity=new CmResettleLogQuery();
		//todo
