...
import com.ndlan.ieream.query.CmAccreditQuery;
import com.ndlan.ieream.model.CmAccreditBean;

public class CmAccreditBeanBustinessRestfulTest {
	
	CmAccreditBeanBustinessRestful productCatatoryBustinessRestful=
			new CmAccreditBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmAccreditBean entity=new CmAccreditBean();
		//todo
	...
	public void selectList() {
		CmAccreditQuery entity=new CmAccreditQuery();
		//todo
