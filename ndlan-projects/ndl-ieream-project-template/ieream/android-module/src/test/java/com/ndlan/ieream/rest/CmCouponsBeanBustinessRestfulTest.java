...
import com.ndlan.ieream.query.CmCouponsQuery;
import com.ndlan.ieream.model.CmCouponsBean;

public class CmCouponsBeanBustinessRestfulTest {
	
	CmCouponsBeanBustinessRestful productCatatoryBustinessRestful=
			new CmCouponsBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmCouponsBean entity=new CmCouponsBean();
		//todo
	...
	public void selectList() {
		CmCouponsQuery entity=new CmCouponsQuery();
		//todo
