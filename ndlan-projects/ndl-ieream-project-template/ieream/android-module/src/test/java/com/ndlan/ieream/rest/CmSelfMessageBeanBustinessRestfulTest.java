...
import com.ndlan.ieream.query.CmSelfMessageQuery;
import com.ndlan.ieream.model.CmSelfMessageBean;

public class CmSelfMessageBeanBustinessRestfulTest {
	
	CmSelfMessageBeanBustinessRestful productCatatoryBustinessRestful=
			new CmSelfMessageBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmSelfMessageBean entity=new CmSelfMessageBean();
		//todo
	...
	public void selectList() {
		CmSelfMessageQuery entity=new CmSelfMessageQuery();
		//todo
