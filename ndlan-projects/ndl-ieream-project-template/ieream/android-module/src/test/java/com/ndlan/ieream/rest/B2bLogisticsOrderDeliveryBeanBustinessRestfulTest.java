...
import com.ndlan.ieream.query.B2bLogisticsOrderDeliveryQuery;
import com.ndlan.ieream.model.B2bLogisticsOrderDeliveryBean;

public class B2bLogisticsOrderDeliveryBeanBustinessRestfulTest {
	
	B2bLogisticsOrderDeliveryBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bLogisticsOrderDeliveryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bLogisticsOrderDeliveryBean entity=new B2bLogisticsOrderDeliveryBean();
		//todo
	...
	public void selectList() {
		B2bLogisticsOrderDeliveryQuery entity=new B2bLogisticsOrderDeliveryQuery();
		//todo
