...
import com.ndlan.ieream.query.B2bOrderStatusHisQuery;
import com.ndlan.ieream.model.B2bOrderStatusHisBean;

public class B2bOrderStatusHisBeanBustinessRestfulTest {
	
	B2bOrderStatusHisBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bOrderStatusHisBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bOrderStatusHisBean entity=new B2bOrderStatusHisBean();
		//todo
	...
	public void selectList() {
		B2bOrderStatusHisQuery entity=new B2bOrderStatusHisQuery();
		//todo
