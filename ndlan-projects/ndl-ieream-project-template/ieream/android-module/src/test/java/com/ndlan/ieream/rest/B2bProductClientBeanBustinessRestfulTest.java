...
import com.ndlan.ieream.query.B2bProductClientQuery;
import com.ndlan.ieream.model.B2bProductClientBean;

public class B2bProductClientBeanBustinessRestfulTest {
	
	B2bProductClientBeanBustinessRestful productCatatoryBustinessRestful=
			new B2bProductClientBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		B2bProductClientBean entity=new B2bProductClientBean();
		//todo
	...
	public void selectList() {
		B2bProductClientQuery entity=new B2bProductClientQuery();
		//todo
