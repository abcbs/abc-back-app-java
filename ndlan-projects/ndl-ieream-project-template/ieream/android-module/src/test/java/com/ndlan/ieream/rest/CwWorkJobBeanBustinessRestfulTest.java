...
import com.ndlan.ieream.query.CwWorkJobQuery;
import com.ndlan.ieream.model.CwWorkJobBean;

public class CwWorkJobBeanBustinessRestfulTest {
	
	CwWorkJobBeanBustinessRestful productCatatoryBustinessRestful=
			new CwWorkJobBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwWorkJobBean entity=new CwWorkJobBean();
		//todo
	...
	public void selectList() {
		CwWorkJobQuery entity=new CwWorkJobQuery();
		//todo
