...
import com.ndlan.ieream.query.CmIndexFavoriteQuery;
import com.ndlan.ieream.model.CmIndexFavoriteBean;

public class CmIndexFavoriteBeanBustinessRestfulTest {
	
	CmIndexFavoriteBeanBustinessRestful productCatatoryBustinessRestful=
			new CmIndexFavoriteBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmIndexFavoriteBean entity=new CmIndexFavoriteBean();
		//todo
	...
	public void selectList() {
		CmIndexFavoriteQuery entity=new CmIndexFavoriteQuery();
		//todo
