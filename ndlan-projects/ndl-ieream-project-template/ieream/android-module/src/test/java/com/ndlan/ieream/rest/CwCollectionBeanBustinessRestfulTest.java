...
import com.ndlan.ieream.query.CwCollectionQuery;
import com.ndlan.ieream.model.CwCollectionBean;

public class CwCollectionBeanBustinessRestfulTest {
	
	CwCollectionBeanBustinessRestful productCatatoryBustinessRestful=
			new CwCollectionBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwCollectionBean entity=new CwCollectionBean();
		//todo
	...
	public void selectList() {
		CwCollectionQuery entity=new CwCollectionQuery();
		//todo
