...
import com.ndlan.ieream.query.CmDataLogQuery;
import com.ndlan.ieream.model.CmDataLogBean;

public class CmDataLogBeanBustinessRestfulTest {
	
	CmDataLogBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDataLogBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDataLogBean entity=new CmDataLogBean();
		//todo
	...
	public void selectList() {
		CmDataLogQuery entity=new CmDataLogQuery();
		//todo
