...
import com.ndlan.ieream.query.CmDishesAppraiseReplyQuery;
import com.ndlan.ieream.model.CmDishesAppraiseReplyBean;

public class CmDishesAppraiseReplyBeanBustinessRestfulTest {
	
	CmDishesAppraiseReplyBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesAppraiseReplyBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesAppraiseReplyBean entity=new CmDishesAppraiseReplyBean();
		//todo
	...
	public void selectList() {
		CmDishesAppraiseReplyQuery entity=new CmDishesAppraiseReplyQuery();
		//todo
