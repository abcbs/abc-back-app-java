...
import com.ndlan.ieream.query.CmBackupQuery;
import com.ndlan.ieream.model.CmBackupBean;

public class CmBackupBeanBustinessRestfulTest {
	
	CmBackupBeanBustinessRestful productCatatoryBustinessRestful=
			new CmBackupBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmBackupBean entity=new CmBackupBean();
		//todo
	...
	public void selectList() {
		CmBackupQuery entity=new CmBackupQuery();
		//todo
