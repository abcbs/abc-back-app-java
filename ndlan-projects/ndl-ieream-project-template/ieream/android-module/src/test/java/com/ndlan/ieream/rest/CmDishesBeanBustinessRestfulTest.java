...
import com.ndlan.ieream.query.CmDishesQuery;
import com.ndlan.ieream.model.CmDishesBean;

public class CmDishesBeanBustinessRestfulTest {
	
	CmDishesBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesBean entity=new CmDishesBean();
		//todo
	...
	public void selectList() {
		CmDishesQuery entity=new CmDishesQuery();
		//todo
