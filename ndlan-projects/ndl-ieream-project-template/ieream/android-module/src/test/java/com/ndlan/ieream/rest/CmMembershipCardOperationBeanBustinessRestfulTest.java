...
import com.ndlan.ieream.query.CmMembershipCardOperationQuery;
import com.ndlan.ieream.model.CmMembershipCardOperationBean;

public class CmMembershipCardOperationBeanBustinessRestfulTest {
	
	CmMembershipCardOperationBeanBustinessRestful productCatatoryBustinessRestful=
			new CmMembershipCardOperationBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmMembershipCardOperationBean entity=new CmMembershipCardOperationBean();
		//todo
	...
	public void selectList() {
		CmMembershipCardOperationQuery entity=new CmMembershipCardOperationQuery();
		//todo
