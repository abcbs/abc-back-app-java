...
import com.ndlan.ieream.query.CmDeliveryQuery;
import com.ndlan.ieream.model.CmDeliveryBean;

public class CmDeliveryBeanBustinessRestfulTest {
	
	CmDeliveryBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDeliveryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDeliveryBean entity=new CmDeliveryBean();
		//todo
	...
	public void selectList() {
		CmDeliveryQuery entity=new CmDeliveryQuery();
		//todo
