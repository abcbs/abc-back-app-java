...
import com.ndlan.ieream.query.CmDinerBillZizhuQuery;
import com.ndlan.ieream.model.CmDinerBillZizhuBean;

public class CmDinerBillZizhuBeanBustinessRestfulTest {
	
	CmDinerBillZizhuBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDinerBillZizhuBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDinerBillZizhuBean entity=new CmDinerBillZizhuBean();
		//todo
	...
	public void selectList() {
		CmDinerBillZizhuQuery entity=new CmDinerBillZizhuQuery();
		//todo
