...
import com.ndlan.ieream.query.CmMembershipCardClassQuery;
import com.ndlan.ieream.model.CmMembershipCardClassBean;

public class CmMembershipCardClassBeanBustinessRestfulTest {
	
	CmMembershipCardClassBeanBustinessRestful productCatatoryBustinessRestful=
			new CmMembershipCardClassBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmMembershipCardClassBean entity=new CmMembershipCardClassBean();
		//todo
	...
	public void selectList() {
		CmMembershipCardClassQuery entity=new CmMembershipCardClassQuery();
		//todo
