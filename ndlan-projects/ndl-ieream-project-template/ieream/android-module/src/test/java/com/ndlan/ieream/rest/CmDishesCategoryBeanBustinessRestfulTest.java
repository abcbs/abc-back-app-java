...
import com.ndlan.ieream.query.CmDishesCategoryQuery;
import com.ndlan.ieream.model.CmDishesCategoryBean;

public class CmDishesCategoryBeanBustinessRestfulTest {
	
	CmDishesCategoryBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesCategoryBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesCategoryBean entity=new CmDishesCategoryBean();
		//todo
	...
	public void selectList() {
		CmDishesCategoryQuery entity=new CmDishesCategoryQuery();
		//todo
