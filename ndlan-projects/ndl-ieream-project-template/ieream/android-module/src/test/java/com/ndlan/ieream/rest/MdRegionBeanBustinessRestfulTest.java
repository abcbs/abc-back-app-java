...
import com.ndlan.ieream.query.MdRegionQuery;
import com.ndlan.ieream.model.MdRegionBean;

public class MdRegionBeanBustinessRestfulTest {
	
	MdRegionBeanBustinessRestful productCatatoryBustinessRestful=
			new MdRegionBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		MdRegionBean entity=new MdRegionBean();
		//todo
	...
	public void selectList() {
		MdRegionQuery entity=new MdRegionQuery();
		//todo
