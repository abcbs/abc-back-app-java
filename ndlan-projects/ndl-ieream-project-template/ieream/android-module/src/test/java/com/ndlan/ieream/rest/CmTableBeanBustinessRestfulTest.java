...
import com.ndlan.ieream.query.CmTableQuery;
import com.ndlan.ieream.model.CmTableBean;

public class CmTableBeanBustinessRestfulTest {
	
	CmTableBeanBustinessRestful productCatatoryBustinessRestful=
			new CmTableBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmTableBean entity=new CmTableBean();
		//todo
	...
	public void selectList() {
		CmTableQuery entity=new CmTableQuery();
		//todo
