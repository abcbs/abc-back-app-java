...
import com.ndlan.ieream.query.CmDishesAppraiseQuery;
import com.ndlan.ieream.model.CmDishesAppraiseBean;

public class CmDishesAppraiseBeanBustinessRestfulTest {
	
	CmDishesAppraiseBeanBustinessRestful productCatatoryBustinessRestful=
			new CmDishesAppraiseBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmDishesAppraiseBean entity=new CmDishesAppraiseBean();
		//todo
	...
	public void selectList() {
		CmDishesAppraiseQuery entity=new CmDishesAppraiseQuery();
		//todo
