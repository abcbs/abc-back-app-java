...
import com.ndlan.ieream.query.CmTableOrderQuery;
import com.ndlan.ieream.model.CmTableOrderBean;

public class CmTableOrderBeanBustinessRestfulTest {
	
	CmTableOrderBeanBustinessRestful productCatatoryBustinessRestful=
			new CmTableOrderBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmTableOrderBean entity=new CmTableOrderBean();
		//todo
	...
	public void selectList() {
		CmTableOrderQuery entity=new CmTableOrderQuery();
		//todo
