...
import com.ndlan.ieream.query.CwAlertQuery;
import com.ndlan.ieream.model.CwAlertBean;

public class CwAlertBeanBustinessRestfulTest {
	
	CwAlertBeanBustinessRestful productCatatoryBustinessRestful=
			new CwAlertBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwAlertBean entity=new CwAlertBean();
		//todo
	...
	public void selectList() {
		CwAlertQuery entity=new CwAlertQuery();
		//todo
