...
public class LocationsBeanControllerRestful {
	...
	public  LocationsGetListBean getitem(Integer  id){
		...
		FutureTask< LocationsGetListBean > future = new FutureTask< LocationsGetListBean >(new Callable<  LocationsGetListBean >() {
			public  LocationsGetListBean  call() {
				try{
					...
					restTemplate.getForEntity(path+"&loc_type=ream&data_type=exact",  LocationsGetListBean .class);
