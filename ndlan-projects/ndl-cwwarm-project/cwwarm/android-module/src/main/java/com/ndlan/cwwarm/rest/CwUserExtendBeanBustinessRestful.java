...
public class CwUserExtendBeanBustinessRestful {

	private static final String url = BaseAndroidRestfulConfig.moduleServicePath+"cw/user/extend/";
			...
			public Result call() {
				try{
					...
					if(result.getStatus()==Result.Status.OK){
						...
						if(null!=obj){
							CwUserExtendBean[] beans=mapper.convertValue(obj, CwUserExtendBean[].class);
	...
	// @Override
	public Result addOne(final CwUserExtendBean entity) {
	...
	// @Override
	public Result selectList(final CwUserExtendQuery query) {
	...
	// @Override
	public Result editOne(final CwUserExtendBean entity) {
	...
	public Result editSelective(final CwUserExtendBean entity) {
		if(entity.getDefaultId()==null||entity.getDefaultId().trim()==""){
			return new Result(Result.Status.ERROR,"update,pk not null");
		}
		FutureTask<Result> future = new FutureTask<Result>(new Callable<Result>() {
