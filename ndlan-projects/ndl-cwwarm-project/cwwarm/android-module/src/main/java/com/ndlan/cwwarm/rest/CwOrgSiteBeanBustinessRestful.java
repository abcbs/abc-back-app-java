...
public class CwOrgSiteBeanBustinessRestful {

	private static final String url = BaseAndroidRestfulConfig.moduleServicePath+"cw/org/site/";
			...
			public Result call() {
				try{
					...
					if(result.getStatus()==Result.Status.OK){
						...
						if(null!=obj){
							CwOrgSiteBean[] beans=mapper.convertValue(obj, CwOrgSiteBean[].class);
	...
	// @Override
	public Result addOne(final CwOrgSiteBean entity) {
	...
	// @Override
	public Result selectList(final CwOrgSiteQuery query) {
	...
	// @Override
	public Result editOne(final CwOrgSiteBean entity) {
	...
	public Result editSelective(final CwOrgSiteBean entity) {
		if(entity.getDefaultId()==null||entity.getDefaultId().trim()==""){
			return new Result(Result.Status.ERROR,"update,pk not null");
		}
		FutureTask<Result> future = new FutureTask<Result>(new Callable<Result>() {
