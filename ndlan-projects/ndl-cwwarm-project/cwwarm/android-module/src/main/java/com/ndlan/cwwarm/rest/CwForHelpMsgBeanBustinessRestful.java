...
public class CwForHelpMsgBeanBustinessRestful {

	private static final String url = BaseAndroidRestfulConfig.moduleServicePath+"cw/for/help/msg/";
			...
			public Result call() {
				try{
					...
					if(result.getStatus()==Result.Status.OK){
						...
						if(null!=obj){
							CwForHelpMsgBean[] beans=mapper.convertValue(obj, CwForHelpMsgBean[].class);
	...
	// @Override
	public Result addOne(final CwForHelpMsgBean entity) {
	...
	// @Override
	public Result selectList(final CwForHelpMsgQuery query) {
	...
	// @Override
	public Result editOne(final CwForHelpMsgBean entity) {
	...
	public Result editSelective(final CwForHelpMsgBean entity) {
		if(entity.getDefaultId()==null||entity.getDefaultId().trim()==""){
			return new Result(Result.Status.ERROR,"update,pk not null");
		}
		FutureTask<Result> future = new FutureTask<Result>(new Callable<Result>() {
