...
public class CwHoldActivityMsgBeanBustinessRestful {

	private static final String url = BaseAndroidRestfulConfig.moduleServicePath+"cw/hold/activity/msg/";
			...
			public Result call() {
				try{
					...
					if(result.getStatus()==Result.Status.OK){
						...
						if(null!=obj){
							CwHoldActivityMsgBean[] beans=mapper.convertValue(obj, CwHoldActivityMsgBean[].class);
	...
	// @Override
	public Result addOne(final CwHoldActivityMsgBean entity) {
	...
	// @Override
	public Result selectList(final CwHoldActivityMsgQuery query) {
	...
	// @Override
	public Result editOne(final CwHoldActivityMsgBean entity) {
	...
	public Result editSelective(final CwHoldActivityMsgBean entity) {
		if(entity.getDefaultId()==null||entity.getDefaultId().trim()==""){
			return new Result(Result.Status.ERROR,"update,pk not null");
		}
		FutureTask<Result> future = new FutureTask<Result>(new Callable<Result>() {
