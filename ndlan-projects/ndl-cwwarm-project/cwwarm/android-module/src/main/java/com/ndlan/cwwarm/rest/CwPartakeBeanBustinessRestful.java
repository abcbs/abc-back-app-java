...
public class CwPartakeBeanBustinessRestful {

	private static final String url = BaseAndroidRestfulConfig.moduleServicePath+"cw/partake/";
			...
			public Result call() {
				try{
					...
					if(result.getStatus()==Result.Status.OK){
						...
						if(null!=obj){
							CwPartakeBean[] beans=mapper.convertValue(obj, CwPartakeBean[].class);
	...
	// @Override
	public Result addOne(final CwPartakeBean entity) {
	...
	// @Override
	public Result selectList(final CwPartakeQuery query) {
	...
	// @Override
	public Result editOne(final CwPartakeBean entity) {
	...
	public Result editSelective(final CwPartakeBean entity) {
		if(entity.getDefaultId()==null||entity.getDefaultId().trim()==""){
			return new Result(Result.Status.ERROR,"update,pk not null");
		}
		FutureTask<Result> future = new FutureTask<Result>(new Callable<Result>() {
