...
public class CwDonationBeanBustinessRestfulTest {
	
	CwDonationBeanBustinessRestful productCatatoryBustinessRestful=
			new CwDonationBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwDonationBean entity=new CwDonationBean();
		//todo
	...
	public void selectList() {
		CwDonationQuery entity=new CwDonationQuery();
		//todo
