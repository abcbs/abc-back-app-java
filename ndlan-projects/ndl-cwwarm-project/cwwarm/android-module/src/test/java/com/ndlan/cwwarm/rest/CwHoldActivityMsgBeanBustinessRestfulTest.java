...
public class CwHoldActivityMsgBeanBustinessRestfulTest {
	
	CwHoldActivityMsgBeanBustinessRestful productCatatoryBustinessRestful=
			new CwHoldActivityMsgBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CwHoldActivityMsgBean entity=new CwHoldActivityMsgBean();
		//todo
	...
	public void selectList() {
		CwHoldActivityMsgQuery entity=new CwHoldActivityMsgQuery();
		//todo
