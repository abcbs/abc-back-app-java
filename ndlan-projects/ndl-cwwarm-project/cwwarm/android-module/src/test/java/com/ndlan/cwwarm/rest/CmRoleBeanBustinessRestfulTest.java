...
public class CmRoleBeanBustinessRestfulTest {
	
	CmRoleBeanBustinessRestful productCatatoryBustinessRestful=
			new CmRoleBeanBustinessRestful();
	@Test
	...
	public void addOneTest() {
		CmRoleBean entity=new CmRoleBean();
		//todo
	...
	public void selectList() {
		CmRoleQuery entity=new CmRoleQuery();
		//todo
