...
<body>
	...
	<div data-role="footer" data-id="foo1" data-position="fixed">
		<div data-role="navbar">
			<ul>
<li><a href="${ctx}/self/menu" data-icon="search" data-iconpos="notext" data-theme="a" data-inline="true" data-transition="flip">菜谱</a></li>
				<li><a href="${ctx}/self/message" class="ui-btn-active ui-state-persist" data-icon="grid" data-iconpos="notext" data-theme="a" data-inline="true" data-transition="flip">呼叫中心</a></li>
