...
<script type="text/javascript" src="${ctx}/static/js/employe/dishesSetSalesDetail.js"></script>
</head>
<body>
	<div class="small_popup_wrap">
		...
		<div class="small_popup_body_auto">
			<div class="dd_zhuizong" style="overflow-y:auto;">
              <div class="xlmx_tck">
                <table cellpadding="0" cellspacing="0">
                  ...
                  <c:forEach var="dishesSet" items="${dishesSetSalesDetailList}">
                  	  <tr>
	                    <td>${dishesSet.dsName}</td>
	                    <td><fmt:formatNumber value="${dishesSet.unitNumSum}" pattern="#.##" type="number"/></td>
	                    <td><fmt:formatNumber value="${dishesSet.oriCostSum}" pattern="#.##" type="number"/></td>
	                  </tr>
                  </c:forEach>
                </table>
              </div>
			...
			<div class="but-area-s" style="bottom:30px; left:180px;">
				<a class="small-but-dayin mr_28" href="#" onclick="print('${dsCategoryId}','${startDate}','${endDate}');"></a>
