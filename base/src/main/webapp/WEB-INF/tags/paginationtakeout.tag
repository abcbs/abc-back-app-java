...
<div class="page">
	<% if (page.hasPreviousPage()){%>
             <a style="cursor:pointer;"  href="###" onclick="searchTakeout('${current-1}');" class="page_back"></a>
      <%}else{%>
             <a class="page_back_disable"></a>
      <%} %>
   
    <% if (page.hasNextPage()){%>
            <a style="cursor:pointer;"  href="###" onclick="searchTakeout('${current+1}');" class="page_go"></a>		
      <%}else{%>
