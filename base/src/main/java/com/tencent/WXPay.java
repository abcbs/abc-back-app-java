...
//        Configure.setCertLocalPath(certLocalPath);
     ...
     * @throws Exception
     */
    public static String doScanPayBusiness(ScanPayReqData scanPayReqData, ScanPayBusiness.ResultListener resultListener) throws Exception {
        return new ScanPayBusiness().run(scanPayReqData, resultListener);
    }
