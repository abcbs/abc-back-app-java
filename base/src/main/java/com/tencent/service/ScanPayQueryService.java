...
public class ScanPayQueryService extends BaseService{
    ...
    public String request(ScanPayQueryReqData scanPayQueryReqData) throws Exception {
        ...
        ScanPayQueryResData scanPayQueryResData = (ScanPayQueryResData) Util.getObjectFromXML(responseString, ScanPayQueryResData.class);

        return Util.getJsonFromObject(scanPayQueryResData);
    }
