...
import java.io.IOException;
 ...
 public class MemberShipCardInfoPrinter extends AbstractPrinter
   implements Printable
 {
   private PrintMemberCardInfoDatasVo datas;
     ...
     throws JsonParseException, JsonMappingException, IOException
   {
     ...
     gh.drawString("卡类型", this.summary_x_1, print_y);
     gh.drawString(this.datas.getCardClassName(), this.summary_x_2, print_y);
     ...
     print_y += gh.getFont().getSize2D();
     gh.drawString("余  额", this.summary_x_1, print_y);
     ...
     print_y += gh.getFont().getSize2D();
     gh.drawString("积  分", this.summary_x_1, print_y);
     ...
     print_y += gh.getFont().getSize2D();
     gh.drawString("状  态", this.summary_x_1, print_y);
     gh.drawString(this.datas.getCardStatusName(), this.summary_x_2, print_y);
     ...
     print_y += gh.getFont().getSize2D();
     gh.drawString("发卡日期", this.summary_x_1, print_y);
     gh.drawString(this.datas.getCardIssueTime(), this.summary_x_2, print_y);
     ...
     for (String t : strUtil.splitAsLength("会员卡个人信息和使用情况来自餐厅，具体解释权归餐厅所有。", this.stateLineLenght, this.encoding)) {
   ...
   public PrintMemberCardInfoDatasVo getDatas()
   {
     return this.datas;
   }
 
   public void setDatas(PrintMemberCardInfoDatasVo datas) {
     this.datas = datas;
   }
