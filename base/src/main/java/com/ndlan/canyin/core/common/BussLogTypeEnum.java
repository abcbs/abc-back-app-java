...
import java.io.PrintStream;
 ...
 public enum BussLogTypeEnum
 {
   ...
   public static final String enumCode = "BussLogType";
   public static final String enumName = "业务日志类型";
   private String code;
   private String desc;
 
   private BussLogTypeEnum(String code, String desc) { this.code = code;
     this.desc = desc; }
 
   public static String getDesc(String code)
   {
     for (BussLogTypeEnum status : values()) {
   ...
   public static void generateSQL()
   {
     ...
     for (BussLogTypeEnum status : values()) {
       ...
       String itemSql = "insert into md_base_code_item (bci_id,bc_id,bc_code,bci_code,bci_name,bci_desc,is_enable,version) VALUES ( '" + 
         sub_uuid + "' , '" + uuid + "' ,'" + "BussLogType" + "', '" + status.getCode() + "','" + status.getDesc() + "','" + status.getDesc() + "','1',0); ";
