...
import java.io.PrintStream;
 ...
 public enum AuthEnum
 {
   ...
   public static final String enumCode = "Auth";
   public static final String enumName = "客户端权限";
   private String code;
   private String desc;
 
   private AuthEnum(String code, String desc) { this.code = code;
     this.desc = desc; }
 
   public static String getDesc(String code)
   {
     for (AuthEnum status : values()) {
   ...
   public static void generateSQL()
   {
     ...
     for (AuthEnum status : values()) {
       ...
       String itemSql = "insert into md_base_code_item (bci_id,bc_id,bc_code,bci_code,bci_name,bci_desc,is_enable,version) VALUES ( '" + 
         sub_uuid + "' , '" + uuid + "' ,'" + "Auth" + "', '" + status.getCode() + "','" + status.getDesc() + "','" + status.getDesc() + "','1',0); ";
