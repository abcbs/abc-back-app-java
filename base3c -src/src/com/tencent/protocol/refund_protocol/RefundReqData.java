...
public class RefundReqData {
    ...
    private String sign = "";
    private String transaction_id = "1002420238201510301391083889";
    private String out_trade_no = "";
    private String out_refund_no = "0000000050b4c44d0150b93991bf009a";
    private int total_fee =  1400;
    private int refund_fee = 1400;
    private String refund_fee_type = "CNY";
    private String op_user_id = "01";
