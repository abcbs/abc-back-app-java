...
import com.ndlan.canyin.core.common.EstimateStatusEnum;
import java.io.PrintStream;
 ...
 public enum EstimateStatusEnum
 {
   ...
   public static final String enumCode = "EstimateStatus";
   public static final String enumName = "估清状态";
   private String code;
   private String desc;
 
   private EstimateStatusEnum(String code, String desc) { this.code = code;
     this.desc = desc; }
 
   public static String getDesc(String code)
   {
     for (EstimateStatusEnum status : values()) {
   ...
   public static void generateSQL()
   {
     ...
     for (EstimateStatusEnum status : values()) {
       ...
       String itemSql = "insert into md_base_code_item (bci_id,bc_id,bc_code,bci_code,bci_name,bci_desc,is_enable,version) VALUES ( '" + 
         sub_uuid + "' , '" + uuid + "' ,'" + "EstimateStatus" + "', '" + status.getCode() + "','" + status.getDesc() + "','" + status.getDesc() + "','1',0); ";
