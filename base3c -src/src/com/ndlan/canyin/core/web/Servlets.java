 package com.ndlan.canyin.core.web;
 
 import com.ndlan.canyin.core.utils.Encodes;
import com.ndlan.canyin.core.utils.Tools;
 ...
 public class Servlets
 {
   ...
   public static Map<String, Object> getParametersStartingWith(ServletRequest request, String prefix)
   {
     ...
     while ((paramNames != null) && (paramNames.hasMoreElements())) {
       ...
       //String name=Tools.enCodeStr(paramName);
       
       if (("".equals(prefix)) || (paramName.startsWith(prefix))) {
         String unprefixed = paramName.substring(prefix.length());
         String[] values = request.getParameterValues(paramName);
         //Tools.enCodeStrback(values);
   ...
   public static Map<String, Object> getParametersStartingWithlist(ServletRequest request, String prefix)
   {
     Validate.notNull(request, "Request must not be null", new Object[0]);
